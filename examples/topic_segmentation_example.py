...
def main() -> int:
    ...
    if len(sys.argv) < 2:
        ...
        print("Example: python examples/topic_segmentation_example.py \"This is a long transcript about AI and technology topics that should be segmented into different themes and subjects for analysis.\"")
        return 1
    ...
    print("✅ Topic segmentation completed!"    print(f"   Model: {data['model']}")
    ...
    if segments:
        ...
        for i, segment in enumerate(segments[:8]):  # Show first 8 segments
            ...
            print(f"   {i+1:2d}. [{start_time:6.1f}s - {end_time:6.1f}s] "
    ...
    if segments:
        ...
        print("
📊 Coherence Analysis:"        print(f"   Average segment coherence: {avg_coherence:.2f}")
