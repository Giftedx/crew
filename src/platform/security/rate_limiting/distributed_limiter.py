...
class DistributedRateLimiter:
    ...
    def __init__(self, redis_url: str, default_capacity: int=60, default_refill_per_sec: float=1.0, fallback_to_local: bool=True):
    ...
    def _check_distributed(self, key: str, cost: int, capacity: int, refill_per_sec: float) -> StepResult:
        ...
        try:
            result = self.redis_client.eval(self.lua_script, 1, f'rl:{key}', capacity, refill_per_sec, now_microseconds, cost)
