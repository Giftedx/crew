...
class OpenAIService:
    ...
    def __init__(self):
        ...
        self.client = AsyncOpenAI(api_key=self.settings.base_config.openai_api_key, base_url=self.settings.base_config.openai_base_url)
        self.max_retries = 3
    ...
    def _get_model_config(self, model: str) -> dict[str, Any]:
        ...
        return {'model': model, 'max_tokens': self.settings.base_config.openai_max_tokens, 'temperature': self.settings.base_config.openai_temperature}
