...
class RouteStatePool:
    ...
    def __init__(self, max_size: int = 20) -> None:
        ...
        self._pool = ObjectPool(
            factory=self._create_route_state,
            max_size=max_size,
            reset_func=self._reset_route_state,
        )
...
class RequestResponsePool:
    ...
    def __init__(self, max_size: int = 50) -> None:
        ...
        """
        self._pool = ObjectPool(
            factory=self._create_response_dict,
            max_size=max_size,
            reset_func=self._reset_response_dict,
        )
        self._feature_flags = FeatureFlags()
...
class MetricsPool:
    ...
    def __init__(self, max_size: int = 30) -> None:
        ...
        """
        self._pool = ObjectPool(
            factory=self._create_metrics_dict,
            max_size=max_size,
            reset_func=self._reset_metrics_dict,
        )
        self._feature_flags = FeatureFlags()
...
class ObjectPoolManager:
    ...
    def get_stats(self) -> dict[str, Any]:
        ...
        # Assume each object saves ~1KB of allocation overhead
