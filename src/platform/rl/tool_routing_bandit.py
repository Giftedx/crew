...
class ToolContextualBandit:
    ...
    def select_tool(
        ...
        try:
            ...
            selection = ToolSelection(
                ...
                reasoning=f"Selected {selected_tool.tool_name} for {task_type} (confidence={confidence:.2f}, success_rate={selected_tool.success_rate:.2f})",
    ...
    def update(
        self, tool_id: str, context: np.ndarray, reward: float, latency_ms: float | None = None, success: bool = True
    ) -> None:
    ...
    def submit_tool_feedback(
        ...
        try:
            ...
            self.feedback_queue.append(
                {"tool_id": tool_id, "context": context, "reward": reward, "success": success, "latency_ms": latency_ms}
            )
