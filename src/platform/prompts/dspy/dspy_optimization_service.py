...
class AgentOptimizer:
    ...
    def load_optimized_module(
        self, agent_name: str, version: str = "v1", signature: dspy.Signature | None = None
    ) -> StepResult:
        """
...
if __name__ == "__main__":
    ...
    result = optimizer_service.optimize_agent_prompt(
        agent_signature=signature, training_examples=train_set, metric=example_metric, optimization_level="light"
    )
    if result.success:
