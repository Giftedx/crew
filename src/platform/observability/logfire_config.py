...
def setup_logfire(app: Any | None=None) -> bool:
    ...
    try:
        ...
        return False
    try:
        kwargs: dict[str, Any] = {'project_name': getattr(cfg, 'logfire_project_name', 'discord-intelligence-bot'), 'service_version': getattr(cfg, 'logfire_service_version', None), 'send_to_logfire': getattr(cfg, 'logfire_send_to_logfire', True)}
