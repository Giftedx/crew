...
class LlamaIndexRAGService:
    ...
    def ingest_documents(
        ...
        try:
            ...
            return StepResult.fail(f"Failed to ingest documents: {str(e)}")
    ...
    def query(
        ...
        try:
            ...
            return StepResult.fail(f"Failed to query RAG system: {str(e)}")
    ...
    def retrieve_context(
        ...
        try:
            ...
            return StepResult.fail(f"Failed to retrieve context: {str(e)}")
    ...
    def update_index(self) -> StepResult:
        ...
        try:
            ...
            return StepResult.fail(f"Failed to update index: {str(e)}")
    ...
    def get_stats(self) -> StepResult:
        ...
        try:
            ...
            return StepResult.fail(f"Failed to get stats: {str(e)}")
