...
# Base directories
BASE_DIR = Path(os.getenv("CREWAI_BASE_DIR", Path.home() / "CrewAI_Content_System")).expanduser()
...
# yt-dlp paths
YTDLP_DIR = Path(os.getenv("CREWAI_YTDLP_DIR", BASE_DIR.parent / "yt-dlp")).expanduser()
YTDLP_CONFIG = Path(
