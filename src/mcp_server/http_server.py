...
def _http_get_impl(url: str, params: dict[str, Any] | None=None, use_cache: bool=True, ttl_seconds: int | None=None, max_bytes: int=10000) -> dict:
...
def _http_json_get_impl(url: str, params: dict[str, Any] | None=None, use_cache: bool=True, ttl_seconds: int | None=None, max_bytes: int=20000) -> dict:
...
def http_get(url: str, params: dict[str, Any] | None=None, use_cache: bool=True, ttl_seconds: int | None=None, max_bytes: int=10000) -> dict:
    return _http_get_impl(url, params=params, use_cache=use_cache, ttl_seconds=ttl_seconds, max_bytes=max_bytes)

def http_json_get(url: str, params: dict[str, Any] | None=None, use_cache: bool=True, ttl_seconds: int | None=None, max_bytes: int=20000) -> dict:
    return _http_json_get_impl(url, params=params, use_cache=use_cache, ttl_seconds=ttl_seconds, max_bytes=max_bytes)

@http_mcp.tool
def http_get_tool(url: str, params: dict[str, Any] | None=None, use_cache: bool=True, ttl_seconds: int | None=None, max_bytes: int=10000) -> dict:
    return _http_get_impl(url, params=params, use_cache=use_cache, ttl_seconds=ttl_seconds, max_bytes=max_bytes)

@http_mcp.tool
def http_json_get_tool(url: str, params: dict[str, Any] | None=None, use_cache: bool=True, ttl_seconds: int | None=None, max_bytes: int=20000) -> dict:
    return _http_json_get_impl(url, params=params, use_cache=use_cache, ttl_seconds=ttl_seconds, max_bytes=max_bytes)
...
__all__ = ['allowlist_resource', 'example_header', 'http_get', 'http_get_tool', 'http_json_get', 'http_json_get_tool', 'http_mcp']