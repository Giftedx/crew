...
class XClient:
    ...
    def _make_request(self, endpoint: str, params: dict[str, Any] = None, method: str = "GET") -> StepResult:
        ...
        try:
            ...
            return StepResult.fail(f"X API request failed: {str(e)}")
    ...
    def get_trending_topics(self, woeid: int = 1) -> StepResult:
        ...
        # Note: This would require Twitter API v1.1 which has different authentication
