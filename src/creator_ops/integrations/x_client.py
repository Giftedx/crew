...
class XClient:
    ...
    def get_tweet_mentions(self, user_id: str, max_results: int=10, tweet_fields: list[str] | None=None) -> StepResult:
    ...
    def get_tweet_replies(self, tweet_id: str, max_results: int=10, tweet_fields: list[str] | None=None) -> StepResult:
    ...
    def get_user_followers(self, user_id: str, max_results: int=10, user_fields: list[str] | None=None) -> StepResult:
    ...
    def get_user_following(self, user_id: str, max_results: int=10, user_fields: list[str] | None=None) -> StepResult:
    ...
    def get_tweet_retweets(self, tweet_id: str, max_results: int=10, user_fields: list[str] | None=None) -> StepResult:
    ...
    def get_tweet_quotes(self, tweet_id: str, max_results: int=10, tweet_fields: list[str] | None=None) -> StepResult:
    ...
    def health_check(self) -> StepResult:
        ...
        try:
            ...
            if result.success:
                return StepResult.ok(data={'service': 'x_twitter', 'status': 'healthy', 'bearer_token_configured': bool(self.bearer_token), 'api_key_configured': bool(self.api_key)})
            else:
