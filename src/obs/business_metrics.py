...
def track_processing_time(operation: str) -> Callable[[F], F]:
    ...
    def decorator(func: F) -> F:
        ...
        def wrapper(*args: Any, **kwargs: Any) -> Any:
            ...
            # Get tenant context for labeling
            ctx = current_tenant()
            labels = {
...
class BusinessMetricsCollector:
    ...
    def track_pipeline_success_rate(self) -> dict[str, float]:
        ...
        # This would aggregate existing metrics to calculate success rates
        # Implementation would depend on available metrics infrastructure
        return {
            "overall_success_rate": 0.95,  # Placeholder
