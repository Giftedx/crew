...
class GovernancePolicyTool(VerificationBaseTool):
    ...
    def __init__(self, **kwargs: Any) -> None:
        ...
        self._category_terms: dict[str, tuple[str, ...]] = {'violence': ('violence', 'violent', 'weapon', 'attack', 'threat'), 'sexual': ('nsfw', 'explicit', 'adult'), 'hate': ('hate speech', 'racist', 'discrimination'), 'self_harm': ('suicide', 'self-harm', 'self harm'), 'drugs': ('drugs', 'narcotic', 'illicit'), 'politics': ('political', 'election', 'campaign', 'policy')}
