            ...
            if "h3" in narrative_query.lower() or "ethan" in narrative_query.lower():
                events = [
                    ...
                    NarrativeEvent(
                        ...
                        content_type="stream",
                        event_type="response",
                        timestamp=current_time - 6 * 24 * 3600,
                    ...
                    NarrativeEvent(
                        ...
                        timestamp=current_time - 5 * 24 * 3600,
                ...
                events = [
                    ...
                    NarrativeEvent(
                        ...
                        content_type="video",
                        event_type="reaction",
                        timestamp=current_time - 2 * 24 * 3600,
                ...
                events = [
                    NarrativeEvent(
                        ...
                        content_type="video",
                        event_type="statement",
                        timestamp=current_time - 24 * 3600,
        ...
        try:
            ...
            for event in sorted(timeline["events"], key=lambda x: x["timestamp"]):
                analysis["sentiment_progression"].append(
                    {"timestamp": event["timestamp"], "sentiment": event["sentiment"], "creator": event["creator_id"]}
                )
            for event in sorted(timeline["events"], key=lambda x: x["timestamp"]):
    ...
    def _analyze_viral_propagation(
        ...
        try:
            ...
            for i in range(1, len(sorted_events)):
                ...
                views_diff = current_event["engagement_metrics"].get("views", 0) - prev_event["engagement_metrics"].get(
                    "views", 0
                )
                if time_diff > 0:
