        ...
        try:
            ...
            if primary_creator in self._relationship_insights:
                await self._analyze_relationship_insights(
                    primary_creator, list(self._guest_profiles.values()), self._collaboration_history, tenant, workspace
                )
