...
from ultimate_discord_intelligence_bot.tools import EngagementPredictionTool, EnhancedAnalysisTool, LCSummarizeTool, PerspectiveSynthesizerTool, SentimentTool, TextAnalysisTool, TranscriptIndexTool, TrendForecastingTool
if TYPE_CHECKING:
...
class AnalysisCartographerAgent(BaseAgent):
    ...
    def _get_analysis_tools(self) -> list[BaseTool]:
        ...
        return [EnhancedAnalysisTool(), TextAnalysisTool(), SentimentTool(), PerspectiveSynthesizerTool(), TranscriptIndexTool(), LCSummarizeTool(), TrendForecastingTool(), EngagementPredictionTool()]