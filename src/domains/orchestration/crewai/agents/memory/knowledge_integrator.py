...
from ultimate_discord_intelligence_bot.tools import GraphMemoryTool, HippoRagContinualMemoryTool, MemoryCompactionTool, MemoryStorageTool, MultimodalAnalysisTool, RagHybridTool, RagIngestTool, RagIngestUrlTool, VectorSearchTool
if TYPE_CHECKING:
...
class KnowledgeIntegratorAgent(BaseAgent):
    ...
    def _get_memory_tools(self) -> list[BaseTool]:
        ...
        return [MemoryStorageTool(embedding_fn=embedding_function), GraphMemoryTool(), HippoRagContinualMemoryTool(), MemoryCompactionTool(), RagIngestTool(), RagIngestUrlTool(), RagHybridTool(), VectorSearchTool(), MultimodalAnalysisTool()]