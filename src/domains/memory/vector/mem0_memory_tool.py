...
class Mem0MemorySchema(BaseModel):
    action: Literal['remember', 'recall', 'update', 'delete', 'list', 'history'] = Field(..., description='The memory action to perform.')
...
class Mem0MemoryTool(BaseTool):
    ...
    def _run(self, action: Literal['remember', 'recall', 'update', 'delete', 'list', 'history'], tenant: str, workspace: str, content: str | None=None, query: str | None=None, memory_id: str | None=None, limit: int | None=10) -> StepResult:
        """
