...
@router.post('/jsonrpc')
async def jsonrpc_endpoint(request: Request, x_tenant_id: str | None=Header(default=None, alias='X-Tenant-Id'), x_workspace_id: str | None=Header(default=None, alias='X-Workspace-Id'), x_api_key: str | None=Header(default=None, alias='X-API-Key')):
    ...
    if isinstance(body, list):
        ...
        for item in body:
            ...
            def _execute_one(method_name: str=method, method_params: dict[str, Any] | None=params, request_id: Any=id_val) -> dict[str, Any] | None:
