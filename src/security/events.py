...
def log_security_event(*, actor: str, action: str, resource: str, decision: str, reason: str | None=None, tenant: str | None=None, workspace: str | None=None, **extra: Any) -> None:
