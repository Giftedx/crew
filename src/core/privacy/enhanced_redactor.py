...
class EnhancedRedactor:
    ...
    def __init__(self):
        ...
        # Default masks for different PII types
        self.default_masks = {
    ...
    def validate_redaction(self, original_text: str, redacted_text: str) -> StepResult:
        ...
        """
        try:
            # Check that redacted text is different from original
            if original_text == redacted_text:
                return StepResult.fail("No redaction occurred")

            # Check that redacted text doesn't contain obvious PII patterns
            pii_patterns = [
