...
class PluginExecutor:
    ...
    def run(self, plugin_dir: str | pathlib.Path, granted_scopes: Iterable[str], adapters: dict[str, Any], args: dict[str, Any] | None=None, timeout: float=10.0, *, policy_registry: rl_registry.PolicyRegistry | None=None) -> PluginResult:
        ...
        learn.learn('plugin', {'name': manifest.get('name', plugin_path.name)}, candidates, act, policy_registry=policy_registry)
