...
class YouTubeClient:
    ...
    def _make_request(
        self, endpoint: str, params: dict[str, Any] | None = None, operation: str = "videos"
    ) -> StepResult:
    ...
    def get_video_comments(
        self, video_id: str, max_results: int = 100, order: str = "time", page_token: str | None = None
    ) -> StepResult:
    ...
    def get_live_chat_messages(
        self, live_chat_id: str, max_results: int = 200, page_token: str | None = None
    ) -> StepResult:
    ...
    async def poll_live_chat(
        self, video_id: str, callback: callable, interval_seconds: int = 5, max_duration_minutes: int = 60
    ) -> StepResult:
