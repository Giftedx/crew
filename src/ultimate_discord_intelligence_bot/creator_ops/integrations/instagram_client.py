...
class InstagramClient:
    ...
    async def get_user_media(
        self, creator_id: str, limit: int = 25, after: str | None = None, fields: list[str] | None = None
    ...
    async def get_media_comments(
        self, creator_id: str, media_id: str, limit: int = 25, after: str | None = None
    ...
    async def get_user_stories(
        self, creator_id: str, fields: list[str] | None = None
    ...
    async def get_media_insights(
        self, creator_id: str, media_id: str, metrics: list[str]
    ...
    async def get_hashtag_media(
        self, creator_id: str, hashtag_id: str, limit: int = 25, after: str | None = None
    ) -> StepResult[tuple[list[InstagramMedia], str | None]]:
        """
    ...
    async def create_webhook_subscription(
        self, creator_id: str, callback_url: str, fields: list[str], verify_token: str
    ...
    async def get_long_lived_token(
        self, creator_id: str, short_lived_token: str
    ...
    async def refresh_long_lived_token(
        self, creator_id: str, long_lived_token: str
    ) -> StepResult[InstagramLongLivedToken]:
        """
