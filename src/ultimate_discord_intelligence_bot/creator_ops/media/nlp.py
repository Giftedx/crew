...
class NLPPipeline:
    ...
    def _initialize_models(self) -> None:
        ...
        try:
            ...
            self.toxicity_pipeline = pipeline(
                "text-classification", model="unitary/toxic-bert", device=0 if self.device == "cuda" else -1
            )
    ...
    def analyze_transcript(
        self, aligned_transcript: AlignedTranscript, analysis_options: dict[str, bool] | None = None
    ) -> StepResult:
        """
