        ...
        try:
            ...
            for segment, _, speaker in diarization.itertracks(yield_label=True):
                diarization_segment = DiarizationSegment(
                    start_time=segment.start, end_time=segment.end, speaker=speaker, confidence=None
                )
    ...
    def estimate_speaker_count(self, audio_path: str, min_speakers: int = 1, max_speakers: int = 10) -> StepResult:
        ...
        try:
            ...
            return StepResult.ok(
                data={"estimated_speaker_count": estimated_count, "speakers": sorted(speakers), "confidence": "medium"}
            )
        except Exception as e:
