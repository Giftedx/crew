        ...
        try:
            summary = {
                ...
                "optimization_highlights": {
                    "title": clip_optimization.title_optimization,
                    "description": clip_optimization.description_optimization,
                    "hashtags": clip_optimization.hashtag_recommendations[:3],
                    "platforms": list(clip_optimization.platform_specific_hooks.keys()),
                },
                "recommendations": {
                    "optimization": viral_analysis.optimization_suggestions[:3],
                    "engagement": clip_optimization.engagement_strategies[:3],
                    "clips": viral_analysis.clip_recommendations[:3],
                },
