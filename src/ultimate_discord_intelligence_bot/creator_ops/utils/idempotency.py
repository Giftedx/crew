...
class IdempotencyManager:
    ...
    async def execute_with_idempotency(
        self, operation: Callable[..., T], idempotency_key: str | None = None, ttl: float | None = None, *args, **kwargs
    ) -> T:
        """
            ...
            try:
                ...
                self._store[idempotency_key] = IdempotencyKey(
                    ...
                    metadata={
                        ...
                        "args_hash": hashlib.md5(str(args).encode(), usedforsecurity=False).hexdigest(),
                        "kwargs_hash": hashlib.md5(str(kwargs).encode(), usedforsecurity=False).hexdigest(),
                    },
                )
...
def with_result_idempotency(
    key: str | None = None, ttl: float | None = None, manager: IdempotencyManager | None = None
):
    """
