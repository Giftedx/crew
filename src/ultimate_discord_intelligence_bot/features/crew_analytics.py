    ...
    def compare_crews(self, crew_a: CrewType, crew_b: CrewType) -> StepResult:
        ...
        try:
            ...
            if metrics_a.average_memory_usage > 0:
                memory_efficiency = (
                    (metrics_a.average_memory_usage - metrics_b.average_memory_usage)
    ...
    def _update_crew_metrics(self, execution: CrewExecution) -> None:
        ...
        try:
            ...
            metrics.performance_score = (
                ...
                + 1.0 / max(metrics.average_execution_time, 0.1) * 0.3
                + 1.0 / max(metrics.average_memory_usage, 0.1) * 0.3
            )
