...
class RightsReuseIntelligenceService:
    ...
    def assess_fair_use_risk(
        self, content_description: str, intended_use: str, content_type: str, audience_size: str
    ) -> StepResult:
        ...
        try:
            ...
            for segment in content_segments:
                ...
                alternatives = self.suggest_alternative_content(
                    {"content_type": content_type, "description": segment.get("description", "")}
                )
    ...
    def _check_cache(
        self, content_segments: list[dict[str, Any]], content_type: str, intended_use: str, model: str
    ) -> RightsReuseIntelligenceResult | None:
