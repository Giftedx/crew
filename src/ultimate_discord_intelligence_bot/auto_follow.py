...
def trigger_auto_follow(download_result: dict[str, Any], queue: PriorityQueue, *, tenant: str, workspace: str) -> dict[str, Any]:
    ...
    plan = BackfillPlan(source_type='youtube', uploader_handle=handle_or_url, tenant=tenant, workspace=workspace, since_iso=since_iso, limit=int(os.getenv('AUTO_FOLLOW_MAX_VIDEOS', '200')))
