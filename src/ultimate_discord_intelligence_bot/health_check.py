...
from obs.performance_monitor import get_performance_summary
from obs.resource_monitor import get_current_resource_usage, get_resource_monitor
...
class HealthCheckService:
    ...
    def _check_qdrant(self) -> dict[str, Any]:
        ...
        try:
            ...
            return {
                ...
                "response_time_ms": 100,  # Placeholder - would need actual timing
            }
    ...
    def _check_pipeline_service(self) -> dict[str, Any]:
        ...
        try:
            ...
            # Try to initialize pipeline (validates import and basic init)
            _ = ContentPipeline()
    ...
    def _check_discord_bot(self) -> dict[str, Any]:
        ...
        try:
            ...
            # Check if bot can be initialized (validates import and basic init)
            _ = DiscordBot()
    ...
    def _assess_overall_health(
        ...
        # Check for any critical service failures
        critical_failures = [
