...
class LazyToolLoader:
    ...
    def _check_dependencies(self, tool_name: str) -> bool:
        ...
        tool_dependencies = {'YtDlpDownloadTool': ['yt_dlp'], 'DiscordDownloadTool': ['discord'], 'InstagramDownloadTool': ['instaloader'], 'TikTokDownloadTool': ['tiktok_scraper'], 'TwitchDownloadTool': ['twitch'], 'TwitterDownloadTool': ['tweepy'], 'RedditDownloadTool': ['praw'], 'KickDownloadTool': ['requests'], 'AudioTranscriptionTool': ['whisper', 'torch'], 'EnhancedAnalysisTool': ['openai', 'transformers'], 'FactCheckTool': ['requests', 'beautifulsoup4'], 'MemoryStorageTool': ['qdrant_client'], 'SystemStatusTool': ['psutil'], 'MultimodalAnalysisTool': ['openai', 'PIL'], 'ImageAnalysisTool': ['PIL', 'torchvision'], 'VideoFrameAnalysisTool': ['cv2', 'torch'], 'SocialGraphAnalysisTool': ['networkx'], 'LiveStreamAnalysisTool': ['websockets'], 'AdvancedAudioAnalysisTool': ['librosa', 'torch'], 'TrendAnalysisTool': ['pandas', 'numpy'], 'TrendForecastingTool': ['scikit-learn', 'pandas'], 'VectorSearchTool': ['qdrant_client', 'numpy'], 'RagHybridTool': ['langchain', 'qdrant_client'], 'ResearchAndBriefTool': ['requests', 'beautifulsoup4'], 'StrategicPlanningTool': ['openai'], 'NarrativeTrackerTool': ['requests'], 'CrossPlatformNarrativeTrackingTool': ['requests'], 'CollectiveIntelligenceTool': ['openai'], 'InsightSharingTool': ['openai'], 'KnowledgeOpsTool': ['qdrant_client'], 'Mem0MemoryTool': ['mem0'], 'GraphMemoryTool': ['networkx'], 'HippoRagContinualMemoryTool': ['qdrant_client'], 'OfflineRagTool': ['langchain'], 'RagIngestTool': ['langchain', 'qdrant_client'], 'RagIngestUrlTool': ['langchain', 'qdrant_client'], 'RagQueryVectorStoreTool': ['langchain', 'qdrant_client'], 'UnifiedMemoryTool': ['qdrant_client'], 'UnifiedMemoryStoreTool': ['qdrant_client'], 'UnifiedContextTool': ['qdrant_client'], 'UnifiedRouterTool': ['openai'], 'CostTrackingTool': ['openai'], 'RouterStatusTool': ['openai'], 'UnifiedCacheTool': ['redis'], 'CacheOptimizationTool': ['redis'], 'UnifiedMetricsTool': ['prometheus_client'], 'OrchestrationStatusTool': ['openai'], 'ResourceAllocationTool': ['psutil'], 'EscalationManagementTool': ['openai'], 'QualityAssuranceTool': ['openai'], 'PerformanceOptimizationTool': ['psutil'], 'WorkflowOptimizationTool': ['openai'], 'EarlyExitConditionsTool': ['openai'], 'CheckpointManagementTool': ['openai'], 'TaskRoutingTool': ['openai'], 'ContentTypeRoutingTool': ['openai'], 'AgentBridgeTool': ['openai'], 'PipelineTool': ['openai'], 'MCPCallTool': ['openai'], 'FastMCPClientTool': ['openai'], 'DependencyResolverTool': ['openai'], 'StepResultAuditorTool': ['openai'], 'ObservabilityTool': ['prometheus_client']}
    ...
    def get_cache_stats(self) -> dict[str, int]:
        ...
        return {'tool_cache_size': len(self._tool_cache), 'dependency_cache_size': len(self._dependency_cache), 'import_cache_size': len(self._import_cache)}
