...
class DefaultCrewFactory(CrewFactory):
    ...
    def __init__(self) -> None:
        ...
        self._executors: dict[str, type[CrewExecutor]] = {'unified': UnifiedCrewExecutor, 'default': UnifiedCrewExecutor}
    ...
    def create_executor(self, executor_type: str, config: CrewConfig) -> CrewExecutor:
        ...
        if executor_type not in self._executors:
            ...
            logger.error('crew_factory_unknown_type', executor_type=executor_type, available_types=list(self._executors.keys()))
