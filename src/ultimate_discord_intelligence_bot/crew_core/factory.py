...
class DefaultCrewFactory(CrewFactory):
    ...
    def __init__(self) -> None:
        ...
        logger.debug(
            "crew_factory_initialized",
            available_executors=list(self._executors.keys()),
        )
    ...
    def create_executor(
        ...
        if executor_type not in self._executors:
            ...
            logger.error(
                "crew_factory_unknown_type",
                executor_type=executor_type,
                available_types=list(self._executors.keys()),
            )
    ...
    def register_executor(
        self,
        executor_type: str,
        executor_class: type[CrewExecutor],
    ) -> None:
        ...
        if executor_type in self._executors:
            logger.warning(
                "crew_factory_executor_override",
                executor_type=executor_type,
            )
        ...
        logger.info(
            "crew_factory_executor_registered",
            executor_type=executor_type,
        )
