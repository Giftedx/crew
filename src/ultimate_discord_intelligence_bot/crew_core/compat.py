...
class CrewAdapter:
    ...
    def kickoff(self, inputs: dict[str, Any] | None = None) -> Any:
        ...
        try:
            ...
            # Extract output from StepResult
            if result.step_result.success:
                return self._extract_crew_output(result)
            else:
                # Return error info in format expected by callers
    ...
    def _extract_crew_output(self, result: Any) -> Any:
        ...
        if hasattr(result, "step_result") and hasattr(result.step_result, "data"):
            ...
            # If data has a 'result' key, return that
...
class UltimateDiscordIntelligenceBotCrewAdapter:
    ...
    def __init__(self):
        ...
        # Create crew_core config with sensible defaults
        ...
        # Storage for agent and task definitions
        self._agents: list[Agent] = []
        self._tasks: list[Task] = []

        logger.info(
            "crew_adapter_initialized",
    ...
    def setup_discord_integration(
        ...
        artifact_channel_id: int | None = None,
    ) -> None:
        ...
        logger.warning(
            ...
            "Discord integration is handled separately in the new architecture.",
        )
    ...
    # ===================================================================
    # AGENT METHODS
    # These return agent definitions for the crew
    # ===================================================================
    ...
    # ===================================================================
    # TASK METHODS
    # These return task definitions for the crew
    # ===================================================================
    ...
    # ===================================================================
    # CREW METHOD
    # This returns the configured crew object
    # ===================================================================
    ...
    def crew(self) -> CrewAdapter:
        ...
        """
        # Build agents if not already done
        if not self._agents:
            self._agents = [
        ...
        # Build tasks if not already done
        if not self._tasks:
            self._tasks = [
...
# Convenience alias for easy migration
