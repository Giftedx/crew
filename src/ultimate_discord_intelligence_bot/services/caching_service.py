...
class CachingService:
    ...
    def _initialize_cache(self) -> None:
        ...
        try:
            ...
            self.cache = MultiLevelCache(redis_url=redis_url, max_memory_size=getattr(self.settings, 'CACHE_MEMORY_SIZE', 1000), default_ttl=getattr(self.settings, 'CACHE_DEFAULT_TTL', 3600), enable_disk_cache=getattr(self.settings, 'CACHE_ENABLE_DISK', False), disk_cache_path=getattr(self.settings, 'CACHE_DISK_PATH', '/tmp/cache'))
    ...
    def cache_transcription(self, url: str, transcript: str, tenant: str, workspace: str, ttl: int | None=None) -> bool:
    ...
    def cache_embedding(self, text: str, embedding: list[float], tenant: str, workspace: str, ttl: int | None=None) -> bool:
    ...
    def cache_analysis(self, content: str, analysis: dict[str, Any], tenant: str, workspace: str, ttl: int | None=None) -> bool:
    ...
    def cache_fact_check(self, claim: str, fact_check: dict[str, Any], tenant: str, workspace: str, ttl: int | None=None) -> bool:
