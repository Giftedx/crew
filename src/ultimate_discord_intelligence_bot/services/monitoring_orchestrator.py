...
class RealTimeMonitoringOrchestrator:
    ...
    def _initialize_platform_schedules(self) -> StepResult:
        ...
        platform_configs = {
            "youtube": {"interval_minutes": 5, "priority": 1},
            "twitch": {"interval_minutes": 2, "priority": 1},
            "tiktok": {"interval_minutes": 10, "priority": 2},
            "instagram": {"interval_minutes": 15, "priority": 2},
            "twitter": {"interval_minutes": 5, "priority": 1},
            "reddit": {"interval_minutes": 30, "priority": 3},
            "discord": {"interval_minutes": 2, "priority": 1},
        }
