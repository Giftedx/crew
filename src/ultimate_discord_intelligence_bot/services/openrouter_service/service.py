...
from ..cache import RedisLLMCache
...
try:  # pragma: no cover - optional dependency
    from core.cache.semantic_cache import get_semantic_cache as _default_semantic_cache_get
...
class OpenRouterService:
        ...
        try:
            ...
            if gptcache_flag:
                try:
                    ...
                    ttl = int(getattr(settings, "semantic_cache_ttl_seconds", 3600) or 3600)
    ...
    def route(
        ...
        result = route_prompt(self, prompt, task_type=task_type, model=model, provider_opts=provider_opts)
