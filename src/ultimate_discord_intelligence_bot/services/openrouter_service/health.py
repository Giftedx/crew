...
class HealthChecker:
        ...
        try:
            if self._service.offline_mode:
                return {
                    ...
                    "details": {
                        "mode": "offline",
                        "message": "Service running in offline mode",
                    },
    ...
    async def _check_memory(self) -> dict[str, Any]:
        ...
        try:
            ...
            # Consider healthy if system memory usage < 90% and process memory < 1GB
            ...
            return {
                ...
                "details": {
                    ...
                    "message": "psutil not available for detailed memory check",
                },
            ...
            if not self._feature_flags.ENABLE_OPENROUTER_CIRCUIT_BREAKER:
                return {
                    ...
                    "details": {
                        ...
                        "message": "Circuit breakers not enabled",
                    },
                    "message": "Circuit breakers disabled - not required",
                }

            # Try to get circuit breaker stats
            try:
    ...
    def get_quick_health(self) -> dict[str, Any]:
        ...
        """
        try:
            # Basic checks without async operations
            has_models = bool(self._service.models_map)
            has_prompt_engine = bool(self._service.prompt_engine)
            has_token_meter = bool(self._service.token_meter)
    ...
    def get_stats(self) -> dict[str, Any]:
        ...
        return {
            ...
            "feature_flags": {
                "health_checks_enabled": self._feature_flags.ENABLE_OPENROUTER_HEALTH_CHECKS,
            },
        }
