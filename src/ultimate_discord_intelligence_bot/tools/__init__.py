...
MAPPING = {
    ...
    # Analysis tools
    "AdvancedAudioAnalysisTool": ".analysis.advanced_audio_analysis_tool",
    ...
    "ContentRecommendationTool": ".analysis.content_recommendation_tool",
    "CrossPlatformNarrativeTrackingTool": ".analysis.cross_platform_narrative_tool",
    "EngagementPredictionTool": ".analysis.engagement_prediction_tool",
    ...
    "SteelmanArgumentTool": ".analysis.steelman_argument_tool",
    ...
    "VisualSummaryTool": ".analysis.visual_summary_tool",
