...
MAPPING = {
    ...
    "DiscordMonitorTool": ".discord.discord_monitor_tool",
    "DiscordPostTool": ".discord.discord_post_tool",
    "DiscordPrivateAlertTool": ".discord.discord_private_alert_tool",
    "DiscordQATool": ".discord.discord_qa_tool",
