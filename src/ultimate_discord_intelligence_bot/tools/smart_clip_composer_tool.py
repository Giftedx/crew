...
class SmartClipComposerTool(BaseTool):
    ...
    def _run(
        ...
        try:
            ...
            logger.error(f"Clip composition failed: {str(e)}")
            return StepResult.fail(f"Clip composition failed: {str(e)}")
    ...
    def _retrieve_episode_data(self, episode_id: str, tenant: str, workspace: str) -> dict[str, Any] | None:
        ...
        try:
            ...
            logger.error(f"Failed to retrieve episode data: {str(e)}")
            return None
