...
class WorkflowOptimizationTool(BaseTool):
    ...
    def _analyze_current_performance(self, workflow_execution: dict[str, Any]) -> PerformanceMetrics:
        ...
        return PerformanceMetrics(
            ...
            optimized_execution_time_minutes=current_execution_time,
            current_cost_usd=current_cost,
            optimized_cost_usd=current_cost,
            current_resource_utilization=current_resource_utilization,
            optimized_resource_utilization=current_resource_utilization,
            ...
            if bottleneck.severity in ["high", "critical"]:
                recommendations.append(
                    OptimizationRecommendation(
                        ...
                        effort_score=0.6,
                        estimated_improvement_percent=bottleneck.improvement_opportunity * 100,
            ...
            if task_count > 2:
                recommendations.append(
                    OptimizationRecommendation(
                        ...
                        affected_tasks=[a.get("task_id") for a in assignments if a.get("agent_id") == agent_id],
                        implementation_steps=[
    ...
    def _calculate_optimized_metrics(
        ...
        resource_improvement = (
            optimized_resource_utilization - current_metrics.current_resource_utilization
        ...
        return PerformanceMetrics(
            ...
            parallelization_efficiency=min(1.0, current_metrics.parallelization_efficiency + 0.3),
            bottleneck_count=len(bottlenecks),
            optimization_score=optimization_score,
        )

    def _create_optimization_plan(
        self, recommendations: list[OptimizationRecommendation], bottlenecks: list[BottleneckAnalysis]
    ) -> dict[str, Any]:
        ...
        return {
            ...
            "critical_bottlenecks": [b.__dict__ for b in bottlenecks if b.severity in ["high", "critical"]],
            "success_metrics": {
                "target_execution_time_reduction": 30.0,
                "target_cost_reduction": 25.0,
