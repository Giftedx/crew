        ...
        try:
            ...
            if operation == "execute_task":
                result = self._execute_task(
                    task_id, task_type, payload, priority, dependencies, tenant_id, workspace_id, timeout, max_retries
                )
        ...
        try:
            ...
            if operation == "add_task":
                return self._add_task(
                    task_id, task_type, priority, dependencies, estimated_duration, resource_requirements
                )
