...
class TaskRoutingTool(BaseTool):
        ...
        for task in tasks:
            ...
            if suitable_agents:
                ...
                assignment = TaskAssignment(
                    ...
                    estimated_start_time=current_time + (best_agent.current_load * 60),  # Estimate start time
    ...
    def _update_agent_load(self, agent: AgentCapability, task: TaskRequirement):
        ...
        load_increase = (task.complexity_score * 0.1) + (task.estimated_duration_minutes / 600.0)  # Max 0.2 increase
