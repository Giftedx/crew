    ...
    def _calculate_allocation_summary(
        ...
        return {
            ...
            "utilization_percentage": {
                "cpu_units": (total_allocated["cpu_units"] / (total_allocated["cpu_units"] + resource_pool.cpu_units))
                * 100,
                "memory_mb": (total_allocated["memory_mb"] / (total_allocated["memory_mb"] + resource_pool.memory_mb))
                * 100,
                "gpu_hours": (total_allocated["gpu_hours"] / (total_allocated["gpu_hours"] + resource_pool.gpu_hours))
                * 100,
            },
        }
