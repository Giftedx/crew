        ...
        try:
            ...
            result = asyncio.run(
                self._agent_bridge.validate_insight(
                    insight_id=insight_id, validating_agent_id=agent_id, is_successful=is_successful, feedback=feedback
                )
            )
            return result
        except Exception as e:
    ...
    def _run(self, operation: str, agent_id: str, agent_type: str, **kwargs) -> StepResult:
        ...
        try:
            ...
            return StepResult.fail(
                f"Collective intelligence operation failed: {e!s}", error_context={"exception": str(e)}
            )
