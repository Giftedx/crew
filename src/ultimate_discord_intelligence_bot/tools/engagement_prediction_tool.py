...
class EngagementPredictionTool(BaseTool[StepResult]):
    ...
    def _run(
        ...
        try:
            ...
            return StepResult.fail(f"Engagement prediction failed: {str(e)}")
    ...
    def _calculate_optimal_posting_times(
        ...
        default_times = [
            {"hour": 9, "day": "weekday", "engagement_score": 0.8, "description": "Morning commute"},
            {"hour": 12, "day": "weekday", "engagement_score": 0.9, "description": "Lunch break"},
            {"hour": 18, "day": "weekday", "engagement_score": 0.9, "description": "Evening wind-down"},
            {"hour": 20, "day": "weekday", "engagement_score": 0.8, "description": "Prime time"},
            {"hour": 10, "day": "weekend", "engagement_score": 0.7, "description": "Weekend morning"},
            {"hour": 14, "day": "weekend", "engagement_score": 0.8, "description": "Weekend afternoon"},
        ]
    ...
    def _calculate_engagement_potential_by_time(
        self, optimal_times: list[dict[str, Any]], audience_profiles: list[AudienceProfile] | None
    ) -> dict[str, float]:
    ...
    def _score_content_formats(
        self, formats: list[str], content: dict[str, Any], audience_profiles: list[AudienceProfile] | None
    ) -> dict[str, float]:
    ...
    def _predict_engagement_rates_over_time(
        self, content: dict[str, Any], horizon_hours: int, historical_engagement: dict[str, Any] | None
    ) -> list[float]:
    ...
    def _assess_model_performance(
        self, content_data: list[dict[str, Any]], historical_engagement: dict[str, Any] | None
    ) -> dict[str, Any]:
