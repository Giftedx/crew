...
class ContentRecommendationTool(BaseTool[StepResult]):
    ...
    def _run(
        ...
        try:
            ...
            return StepResult.fail(f"Content recommendation failed: {e!s}")
    ...
    def _assess_recommendation_quality(
        ...
        platforms = {r["platform"] for r in personalized_recommendations}
        content_types = {r["content_type"] for r in personalized_recommendations}
