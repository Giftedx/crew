...
class TrustworthinessTrackerTool(BaseTool[StepResult]):
    ...
    def _run(self, person: str, verdict: bool) -> StepResult:
        ...
        if not person:
            self.metrics.counter(
                "tool_runs_total",
                labels={"tool": "trustworthiness_tracker", "outcome": "skipped"},
            ).inc()
        ...
        try:
            ...
            self.metrics.histogram(
                ...
                score,
                labels={"source_type": self._classify_source(person)},
            )
            self.metrics.counter(
                "tool_runs_total",
                labels={"tool": "trustworthiness_tracker", "outcome": "success"},
            ).inc()
            ...
            self.metrics.counter(
                "tool_runs_total",
                labels={"tool": "trustworthiness_tracker", "outcome": "error"},
            ).inc()
    ...
    def get_report(self) -> StepResult:
        ...
        try:
            ...
            self.metrics.counter(
                "tool_runs_total",
                labels={"tool": "trustworthiness_tracker_report", "outcome": "success"},
            ).inc()
            return StepResult.ok(
                report=report,
            ...
            self.metrics.counter(
                "tool_runs_total",
                labels={"tool": "trustworthiness_tracker_report", "outcome": "error"},
            ).inc()
            return StepResult.fail(error=str(e))
