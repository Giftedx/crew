...
class ImageAnalysisTool(BaseTool[StepResult]):
    ...
    def _run(
        self, image_path: str, tenant: str = "default", workspace: str = "default", analysis_type: str = "comprehensive"
    ) -> StepResult:
        """
    ...
    def _load_image(self, image_path: str) -> dict[str, Any] | None:
        ...
        try:
            if image_path.startswith(("http://", "https://")):
                ...
                if requests is None:
                    logging.error("Requests not available - cannot download image from URL")
                    return None
    ...
    def _analyze_content_moderation(
        ...
        try:
            ...
            if ai_analysis:
                ...
                text_to_check = f"{scene} {str(objects)}"
