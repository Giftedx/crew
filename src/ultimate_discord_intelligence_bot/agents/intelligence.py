...
from ultimate_discord_intelligence_bot.tools.analysis import (  # type: ignore[import-not-found]
    EnhancedAnalysisTool,
    TextAnalysisTool,
)
from ultimate_discord_intelligence_bot.tools.memory import OfflineRagTool  # type: ignore[import-not-found]
...
class IntelligenceAgents:
    ...
    def intelligence_synthesis_specialist(self) -> Agent:
        ...
        return Agent(
            ...
            tools=[
                ...
                RagHybridTool(),
                UnifiedMemoryTool(),
                # UnifiedContextTool(),  # Tool not available
                InsightSharingTool(),
                # CollectiveIntelligenceTool(),  # Tool not available
            ],
            verbose=True,
            allow_delegation=False,
        )
    ...
    def knowledge_management_specialist(self) -> Agent:
        ...
        return Agent(
            ...
            tools=[
                UnifiedMemoryTool(),
                # UnifiedMemoryStoreTool(),  # Tool not available
                # UnifiedContextTool(),  # Tool not available
                Mem0MemoryTool(),
                GraphMemoryTool(),
                VectorSearchTool(),
