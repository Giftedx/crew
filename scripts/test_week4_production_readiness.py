...
async def test_quality_tool_direct():
    ...
    try:
        ...
        low_quality_input = {"transcript": "Um, yeah. This is bad. Not good. Really short."}
...
def estimate_production_impact(results: dict[str, Any]) -> None:
    ...
    ready_for_deployment = (
        results.get("low_quality_bypassed", False)
        and results.get("high_quality_processed", False)
