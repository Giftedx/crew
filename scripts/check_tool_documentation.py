...
def get_documented_tools() -> Set[str]:
    ...
    # Extract tool names from file references like src/ultimate_discord_intelligence_bot/tools/logical_fallacy_tool.py
    ...
    for tool_file in tools_dir.glob("*.py"):
        ...
        try:
            ...
            if expected_class not in class_matches:
                issues.append(f"{tool_file.name}: Expected class '{expected_class}' not found. Found: {class_matches}")
