...
def get_comprehensive_tool_specs(tools_module) -> list[tuple]:
    ...
    specs: list[tuple] = [
        ...
        (get_tool_class(tools_module, "TrustworthinessTrackerTool"), "trustworthiness_tracker_tool", (), {}),
...
def get_discord_tool_specs(tools_module) -> list[tuple]:
    ...
    if discord_webhook:
        specs.append((get_tool_class(tools_module, "DiscordPostTool"), "discord_post_tool", (discord_webhook,), {}))
    else:
