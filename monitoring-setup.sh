...
echo "2. Start services: docker-compose -f production.yml up -d"
...
echo "- View logs: docker-compose -f production.yml logs -f discord-bot"
echo "- Scale bot: docker-compose -f production.yml up -d --scale discord-bot=3"
echo "- Health check: docker-compose -f production.yml ps"
