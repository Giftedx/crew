...
class ScopeValidator:
    ...
    def __init__(self) -> None:
        ...
        # Define required scopes for each platform
        ...
        # Define scope descriptions for audit trails
        ...
        # Define sensitive scopes that require special handling
    ...
    def validate_scopes(self, platform: str, requested_scopes: list[str], purpose: str) -> StepResult:
        ...
        try:
            ...
            # Check if purpose exists for platform
