...
class MonitoringMode(Enum):
    ...
    PASSIVE = "passive"  # Monitor and alert only
    ACTIVE = "active"  # Monitor, alert, and take automated actions
    INTELLIGENT = "intelligent"  # Full AI-powered monitoring with learning
...
class LiveMonitoringAgent:
    ...
    async def start_monitoring_session(
        ...
        try:
            ...
            # Set up monitoring rules based on mode
