...
class DocumentProcessingTool(BaseUniversalTool):
    ...
    async def run(
        ...
        Args:
            ...
            file_format: Document format (auto-detected if "auto")
        ...
        try:
            ...
            mock_text = self._generate_mock_text(file_format, file_path)
            ...
            if extract_metadata:
                result["metadata"] = self._generate_mock_metadata(file_format, file_path)
                result["pages"] = self._estimate_pages(file_format)
    ...
    def _generate_mock_text(self, file_format: str, file_path: str) -> str:
    ...
    def _generate_mock_metadata(self, file_format: str, file_path: str) -> dict[str, Any]:
    ...
    def _estimate_pages(self, file_format: str) -> int:
