...
class TestClaimQuoteExtractionService:
    ...
    def test_extract_from_segments(self) -> None:
        ...
        segments = [
            {"speaker": "Host", "start_time": 0.0, "text": "According to research, AI will change everything."},
            {"speaker": "Guest", "start_time": 30.0, "text": "I believe this is a fact."},
        ]
    ...
    def test_speaker_at_time(self) -> None:
        ...
        speakers = [{"speaker": "Host", "start": 0, "end": 30}, {"speaker": "Guest", "start": 30, "end": 60}]
