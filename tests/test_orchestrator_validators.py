...
class TestValidators:
    ...
    def test_validate_stage_data_success(self):
        ...
        validators.validate_stage_data(
            "test_stage", ["key1", "key2"], {"key1": "value1", "key2": "value2", "extra": "ok"}
        )
    ...
    def test_check_discord_available_with_dummy_webhook(self):
        ...
        with patch.dict(os.environ, {"DISCORD_WEBHOOK": "https://discord.com/api/webhooks/YOUR_WEBHOOK"}):
    ...
    def test_validate_system_prerequisites_all_good(self, mock_run):
        ...
        mock_run.return_value.returncode = 0
        with patch.dict(
            os.environ, {"OPENAI_API_KEY": "test-key", "DISCORD_WEBHOOK": "https://discord.com/api/webhooks/123/abc"}
        ):
