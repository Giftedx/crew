...
class TestAccuracyAssessors:
    ...
    def test_assess_factual_accuracy_with_verification_data(self):
        ...
        # Arrange
        verification_data = {
            "fact_checks": {"verified_claims": 5, "disputed_claims": 1, "evidence": ["evidence1", "evidence2"]}
        }
    ...
    def test_assess_factual_accuracy_with_fact_data(self):
        ...
        # Arrange
        fact_data = {"fact_checks": {"verified_claims": 3, "disputed_claims": 2, "evidence": ["evidence1"]}}
    ...
    def test_assess_source_credibility_with_metadata(self):
        ...
        # Arrange
        knowledge_data = {"content_metadata": {"source_url": "https://example.com", "platform": "youtube"}}
