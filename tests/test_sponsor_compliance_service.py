...
class TestSponsorComplianceAssistant:
    ...
    def test_analyze_compliance_safe_content(self) -> None:
        ...
        content_segments = [
            {"start_time": 0.0, "end_time": 30.0, "text": "This is safe, professional content."},
            {"start_time": 30.0, "end_time": 60.0, "text": "Educational discussion about technology."},
        ]
    ...
    def test_analyze_compliance_unsafe_content(self) -> None:
        ...
        content_segments = [
            {"start_time": 0.0, "end_time": 30.0, "text": "This content contains profanity and hate speech."},
        ]
    ...
    def test_generate_cut_list(self) -> None:
        ...
        content_segments = [
            ...
            {"start_time": 30.0, "end_time": 60.0, "text": "Unsafe content with violations."},
...
class TestSponsorCutList:
    ...
    def test_create_sponsor_cut_list(self) -> None:
        ...
        from features.sponsor_assistant.sponsor_compliance_service import ComplianceSegment
...
class TestSponsorScript:
    ...
    def test_create_sponsor_script(self) -> None:
        ...
        script = SponsorScript(
            script_segments=[
                {"segment_index": 0, "content": "Introduction", "segment_type": "content"},
                {"segment_index": 1, "content": "Sponsor message", "segment_type": "sponsor"},
            ],
...
class TestSponsorComplianceIntegration:
    ...
    def test_end_to_end_compliance_workflow(self) -> None:
        ...
        content_segments = [
            {"start_time": 0.0, "end_time": 30.0, "text": "This is safe educational content."},
            {"start_time": 30.0, "end_time": 60.0, "text": "This contains profanity and should be flagged."},
            {"start_time": 60.0, "end_time": 90.0, "text": "This is also safe content."},
        ]
