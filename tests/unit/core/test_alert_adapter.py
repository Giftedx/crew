...
def test_alert_adapter_posts_to_discord(monkeypatch):
    ...
    payload = {'status': 'firing', 'alerts': [{'labels': {'alertname': 'LLMLatencyP95High', 'tenant': 'default', 'workspace': 'main', 'severity': 'warning'}, 'annotations': {'summary': 'LLM latency high', 'description': 'p95 > 2.5s'}}]}
