...
class TestConfiguration:
    ...
    def test_environment_variables(self):
        ...
        with patch.dict('os.environ', {'DISCORD_BOT_TOKEN': 'test_token', 'OPENAI_API_KEY': 'test_key', 'QDRANT_URL': 'http://localhost:6333'}):
            settings = get_settings()
    ...
    def test_database_configuration(self):
        ...
        with patch.dict('os.environ', {'POSTGRES_URL': 'postgresql://test:test@localhost:5432/test', 'REDIS_URL': 'redis://localhost:6379'}):
            settings = get_settings()
