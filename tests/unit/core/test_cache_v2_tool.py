...
class TestCacheV2Tool:
    ...
    def test_disabled_feature_flag(self):
        ...
        result = self.tool._run(
            operation="get", cache_name="test", key="test_key", tenant="test_tenant", workspace="test_workspace"
        )
    ...
    def test_set_operation_missing_value(self):
        ...
        result = self.tool._run(
            operation="set", cache_name="test", key="test_key", tenant="test_tenant", workspace="test_workspace"
        )
        result_obj = StepResult.from_json(result)
        assert not result_obj.success
    ...
    def test_delete_operation(self, mock_namespace, mock_cache_factory):
        ...
        mock_namespace.return_value = Mock()
        result = self.tool._run(
            operation="delete", cache_name="test", key="test_key", tenant="test_tenant", workspace="test_workspace"
        )
        result_obj = StepResult.from_json(result)
        assert result_obj.success
    ...
    def test_get_stats_operation(self, mock_namespace, mock_cache_factory):
        ...
        mock_namespace.return_value = Mock()
        result = self.tool._run(
            operation="get_stats", cache_name="test", key="test_key", tenant="test_tenant", workspace="test_workspace"
        )
        result_obj = StepResult.from_json(result)
        assert result_obj.success
    ...
    def test_unknown_operation(self):
        ...
        result = self.tool._run(
            operation="unknown", cache_name="test", key="test_key", tenant="test_tenant", workspace="test_workspace"
        )
        result_obj = StepResult.from_json(result)
        assert not result_obj.success
