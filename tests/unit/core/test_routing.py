...
from platform.core.routing.base_router import BanditRouter, CostAwareRouter, FallbackRouter, LatencyOptimizedRouter, RoutingDecision, RoutingRequest, UnifiedRouter
...
class TestRoutingRequest:
    ...
    def test_routing_request_creation(self) -> None:
        ...
        request = RoutingRequest(prompt='Test prompt', context={'key': 'value'}, constraints={'minimize_cost': True}, tenant='test_tenant', workspace='test_workspace')
    ...
    def test_routing_request_id_generation(self) -> None:
        ...
        request1 = RoutingRequest(prompt='Test prompt', context={}, constraints={}, tenant='test_tenant', workspace='test_workspace')
        request2 = RoutingRequest(prompt='Test prompt', context={}, constraints={}, tenant='test_tenant', workspace='test_workspace')
...
class TestRoutingDecision:
    ...
    def test_routing_decision_creation(self) -> None:
        ...
        decision = RoutingDecision(model_id='gpt-4o-mini', provider='openai', estimated_cost=0.001, estimated_latency=1.5, confidence=0.8, reasoning='Test reasoning', request_id='test_request_123', strategy_used='bandit', timestamp=time.time())
...
class TestBanditRouter:
    ...
    def test_bandit_router_route(self) -> None:
        ...
        router = BanditRouter()
        request = RoutingRequest(prompt='Test prompt', context={}, constraints={}, tenant='test_tenant', workspace='test_workspace')
...
class TestCostAwareRouter:
    ...
    def test_cost_aware_router_route(self) -> None:
        ...
        router = CostAwareRouter()
        request = RoutingRequest(prompt='Test prompt', context={}, constraints={'minimize_cost': True}, tenant='test_tenant', workspace='test_workspace')
        result = router.route(request)
        assert result.success
        assert isinstance(result.data, dict)
        assert 'data' in result.data
...
class TestLatencyOptimizedRouter:
    ...
    def test_latency_optimized_router_route(self) -> None:
        ...
        router = LatencyOptimizedRouter()
        request = RoutingRequest(prompt='Test prompt', context={}, constraints={'minimize_latency': True}, tenant='test_tenant', workspace='test_workspace')
        result = router.route(request)
        assert result.success
        assert isinstance(result.data, dict)
        assert 'data' in result.data
...
class TestUnifiedRouter:
    ...
    def test_cache_key_generation(self) -> None:
        ...
        router = UnifiedRouter()
        request1 = RoutingRequest(prompt='Test prompt', context={}, constraints={'minimize_cost': True}, tenant='test_tenant', workspace='test_workspace')
        request2 = RoutingRequest(prompt='Test prompt', context={}, constraints={'minimize_cost': True}, tenant='test_tenant', workspace='test_workspace')
    ...
    def test_cache_clearing(self) -> None:
        ...
        router = UnifiedRouter()
        request = RoutingRequest(prompt='Test prompt', context={}, constraints={}, tenant='test_tenant', workspace='test_workspace', request_id='test_request_123')
