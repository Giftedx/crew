...
def test_pricing_overlay_downshifts_model(tmp_path: Path) -> None:
    ...
    _write_yaml(acme / 'routing.yaml', {'models': {'default': 'openai/gpt-4'}, 'allowed_models': ['gpt-4o-mini', 'gpt-4']})
    _write_yaml(acme / 'budgets.yaml', {'limits': {'max_per_request': 0.01}, 'pricing': {'openai/gpt-4': 0.03, 'openai/gpt-4o-mini': 0.00015}})
