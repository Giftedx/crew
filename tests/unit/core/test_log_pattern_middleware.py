...
from ultimate_discord_intelligence_bot.pipeline_components.log_pattern_middleware import (
    LogPatternMiddleware,
)
...
def test_log_pattern_middleware_attaches_summary() -> None:
    ...
    # Top patterns should reflect the repeated warning message after normalisation.
...
class _ObservabilityPipeline(PipelineExecutionMixin):
    ...
    async def _run_with_retries(  # type: ignore[override]
        self,
        func,
        *args,
        **kwargs,
    ...
    def _record_step_metrics(  # type: ignore[override]
        self,
        step: str,
        outcome: str,
        duration: float | None,
    ...
    def _record_pipeline_duration(  # type: ignore[override]
        self, status: str, duration: float
    ) -> None:
        return None

    def _record_dashboard_metrics_background(  # type: ignore[override]
        self,
