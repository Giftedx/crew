...
from platform.core.step_result import ErrorAnalyzer, ErrorCategory, ErrorContext, ErrorRecoveryStrategy, ErrorSeverity, StepResult
...
class TestEnhancedSystemIntegration:
    ...
    def test_enhanced_step_result_functionality(self):
        ...
        strategy = ErrorRecoveryStrategy(error_categories=[ErrorCategory.NETWORK, ErrorCategory.TIMEOUT], max_retries=3, retry_delay_base=1.0)
