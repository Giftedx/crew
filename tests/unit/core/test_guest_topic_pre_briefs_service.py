...
class TestGuestTopicPreBriefsService:
    ...
    def test_generate_interview_brief_basic(self) -> None:
        ...
        result = self.service.generate_interview_brief(guest_content, guest_name="Test Guest", use_cache=False)
    ...
    def test_logical_coherence_assessment(self) -> None:
        ...
        coherent = "Because research shows this works, therefore we should implement it."
        ...
        summary = OpponentProcessSummary(
            ...
            key_arguments=[
                ArgumentAnalysis(
                    ...
                    potential_counterarguments=["Over-regulation could stifle innovation"],
                )
            ],
...
class TestGuestTopicPreBriefsIntegration:
    ...
    def test_live_fact_check_prompt_generation(self) -> None:
        ...
        moderate_confidence_statements = [s for s in guest_statements if 0.3 <= s["confidence"] <= 0.8]
    ...
    def test_audience_reaction_prediction_with_topics(self) -> None:
        ...
        # Controversial topics
        controversial_topics = ["politics", "controversial_issues", "debated_topics"]
        controversial_prediction = self.service.predict_audience_reactions(controversial_topics)
        ...
        assert controversial_prediction.controversy_risk >= safe_prediction.controversy_risk

        # Safe topics should have higher engagement potential
        assert safe_prediction.engagement_potential >= controversial_prediction.engagement_potential
