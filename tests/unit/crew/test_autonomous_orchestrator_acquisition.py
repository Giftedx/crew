...
def test_content_acquisition_flattens_pipeline_payload():
    ...
    pipeline_payload = {'status': 'success', 'download': {'status': 'success', 'title': 'Sample Video', 'platform': 'youtube'}, 'transcription': {'status': 'success', 'transcript': 'hello world'}, 'analysis': {'status': 'success', 'summary': 'Example analysis'}, 'fallacy': {'status': 'success', 'fallacies': []}, 'perspective': {'status': 'success', 'summary': 'Multi-angle'}, 'memory': {'status': 'success', 'stored': True}, 'graph_memory': {'status': 'skipped'}, 'hipporag_memory': {'status': 'skipped'}, 'discord': {'status': 'success', 'message_id': 'msg_123'}}
    pipeline_wrapper = {'url': 'https://example.com/video', 'quality': '1080p', 'processing_time': 1.23, 'timestamp': 1700000000.0, 'data': pipeline_payload}
