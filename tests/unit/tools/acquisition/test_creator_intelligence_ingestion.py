...
from mcp_server.tools.creator_intelligence_ingestion import CreatorIntelligenceIngestionTools, IngestedContent, get_ingestion_tools
...
class TestIngestedContent:
    ...
    def test_create_ingested_content(self) -> None:
        ...
        content = IngestedContent(platform='youtube', content_id='abc123', content_type='episode', creator_id='channel_id', title='Test Video', url='https://youtube.com/watch?v=abc123', published_at='2025-01-17T12:00:00Z', duration_seconds=600, transcript='This is a test transcript.', metadata={'channel': 'Test Channel'})
...
class TestCreatorIntelligenceIngestionTools:
    ...
    def test_ingest_youtube_video_success(self, mock_fetch_transcript: MagicMock, mock_fetch_metadata: MagicMock) -> None:
        """Test successful YouTube video ingestion."""
        mock_fetch_metadata.return_value = VideoMetadata(id='test_video_id', title='Test Video Title', channel='Test Channel', channel_id='test_channel_id', published_at='2025-01-17T12:00:00Z', duration=600.0, url='https://youtube.com/watch?v=test_video_id', thumbnails=['https://img.youtube.com/vi/test_video_id/maxresdefault.jpg'])
        mock_fetch_transcript.return_value = 'This is a test transcript of the video content.'
        result = self.tools.ingest_youtube_video(url='https://youtube.com/watch?v=test_video_id', tenant='test_tenant', workspace='test_workspace', fetch_transcript=True)
    ...
    def test_ingest_youtube_video_metadata_failure(self, mock_fetch_metadata: MagicMock) -> None:
        ...
        result = self.tools.ingest_youtube_video(url='https://youtube.com/watch?v=test_video_id', tenant='test_tenant', workspace='test_workspace')
    ...
    @patch('ingest.providers.youtube.fetch_metadata')
    @patch('ingest.providers.youtube.fetch_transcript')
    def test_ingest_youtube_video_without_transcript(self, mock_fetch_transcript: MagicMock, mock_fetch_metadata: MagicMock) -> None:
        """Test YouTube ingestion without transcript."""
        mock_fetch_metadata.return_value = VideoMetadata(id='test_id', title='Test', channel='Channel', channel_id='ch123', published_at=None, duration=None, url='https://youtube.com/watch?v=test_id', thumbnails=[])
        result = self.tools.ingest_youtube_video(url='https://youtube.com/watch?v=test_id', tenant='test_tenant', workspace='test_workspace', fetch_transcript=False)
    ...
    def test_ingest_twitch_clip_success(self, mock_fetch_transcript: MagicMock, mock_fetch_metadata: MagicMock) -> None:
        ...
        mock_fetch_metadata.return_value = ClipMetadata(id='test_clip_id', title='Amazing Clip', streamer='test_streamer', published_at='2025-01-17T12:00:00Z', duration=30.0, url='https://clips.twitch.tv/test_clip_id')
        mock_fetch_transcript.return_value = 'clip'
        result = self.tools.ingest_twitch_clip(url='https://clips.twitch.tv/test_clip_id', tenant='test_tenant', workspace='test_workspace')
        assert result.success
        assert result.data is not None
    ...
    def test_batch_ingest_not_implemented(self) -> None:
        ...
        result = self.tools.batch_ingest_youtube_channel(channel_url='https://youtube.com/@test_channel', tenant='test_tenant', workspace='test_workspace', max_videos=10)
        assert not result.success
    ...
    def test_compute_content_hash(self) -> None:
        ...
        content = IngestedContent(platform='youtube', content_id='abc123', content_type='episode', creator_id='creator', title='Test', url='https://youtube.com/test', published_at=None, duration_seconds=None, transcript=None, metadata={})
...
class TestIngestionWithVectorStorage:
    ...
    def test_ingest_with_vector_storage(self, mock_fetch_transcript: MagicMock, mock_fetch_metadata: MagicMock) -> None:
        ...
        mock_fetch_metadata.return_value = VideoMetadata(id='vec_test_id', title='Vector Test', channel='Test Channel', channel_id='ch123', published_at='2025-01-17T12:00:00Z', duration=300.0, url='https://youtube.com/watch?v=vec_test_id', thumbnails=[])
        mock_fetch_transcript.return_value = 'This is a transcript for vector embedding testing.'
        result = self.tools.ingest_youtube_video(url='https://youtube.com/watch?v=vec_test_id', tenant='test_tenant', workspace='test_workspace', fetch_transcript=True)
        assert result.success