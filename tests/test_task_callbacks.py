...
class TestTaskCallbacks:
    ...
    def test_task_completion_callback_success(self):
        ...
        task_callbacks.task_completion_callback(
            task_output, populate_agent_context_callback=populate_callback, agent_coordinators=agent_coordinators
        )
    ...
    def test_task_completion_callback_extract_key_values(self):
        ...
        extract_key_values_callback.return_value = {"transcript": "test content", "quality": 0.8}
