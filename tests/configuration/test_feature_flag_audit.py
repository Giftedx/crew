...
from platform.core.configuration.feature_flag_audit import FeatureFlag, FeatureFlagAuditor, FeatureFlagAuditResult, audit_feature_flags, simplify_feature_flags
...
class TestFeatureFlagAuditor:
    ...
    def test_feature_flag_creation(self):
        ...
        flag = FeatureFlag(name='ENABLE_TEST_FEATURE', default_value='false', description='Test feature flag', category='test', usage_count=5, usage_locations=['file1.py', 'file2.py'])
    ...
    def test_discover_feature_flags(self):
        ...
        with patch.object(self.auditor, '_parse_settings_file') as mock_parse:
            mock_parse.return_value = [FeatureFlag(name='ENABLE_TEST_FEATURE', default_value='false', description='Test feature', category='test')]
    ...
    def test_identify_unused_flags(self):
        ...
        self.auditor.flags = [FeatureFlag(name='ENABLE_USED_FEATURE', default_value='false', usage_count=5), FeatureFlag(name='ENABLE_UNUSED_FEATURE', default_value='false', usage_count=0)]
    ...
    def test_identify_deprecated_flags(self):
        ...
        self.auditor.flags = [FeatureFlag(name='ENABLE_LEGACY_FEATURE', default_value='false', usage_count=1), FeatureFlag(name='ENABLE_NEW_FEATURE', default_value='true', usage_count=10)]
    ...
    def test_identify_complex_flags(self):
        ...
        self.auditor.flags = [FeatureFlag(name='ENABLE_VERY_COMPLEX_FEATURE_WITH_LONG_NAME', default_value='false', usage_count=15, usage_locations=['file1.py', 'file2.py', 'file3.py', 'file4.py', 'file5.py', 'file6.py']), FeatureFlag(name='ENABLE_SIMPLE_FEATURE', default_value='false', usage_count=2, usage_locations=['file1.py'])]
    ...
    def test_generate_simplification_recommendations(self):
        ...
        self.auditor.flags = [FeatureFlag(name='ENABLE_CACHE_OPTIMIZATION', default_value='false', category='caching', usage_count=5), FeatureFlag(name='ENABLE_CACHE_PRELOADING', default_value='false', category='caching', usage_count=3), FeatureFlag(name='ENABLE_UNUSED_FEATURE', default_value='false', usage_count=0)]
    ...
    def test_run_comprehensive_audit(self):
        ...
        with patch.object(self.auditor, 'discover_feature_flags') as mock_discover:
            mock_discover.return_value = [FeatureFlag(name='ENABLE_TEST_FEATURE', default_value='false', category='test', usage_count=5)]
    ...
    def test_get_audit_summary(self):
        ...
        self.auditor.flags = [FeatureFlag(name='ENABLE_USED_FEATURE', default_value='false', category='core', usage_count=10), FeatureFlag(name='ENABLE_UNUSED_FEATURE', default_value='false', category='core', usage_count=0)]
    ...
    def test_find_redundant_flag_groups(self):
        ...
        flag_names = ['ENABLE_CACHE_OPTIMIZATION', 'ENABLE_CACHE_PRELOADING', 'ENABLE_CACHE_CLEANUP', 'ENABLE_ROUTER_OPTIMIZATION']
    ...
    def test_determine_flag_category(self):
        ...
        test_cases = [('ENABLE_UNIFIED_CACHE', 'unified_systems'), ('ENABLE_CACHE_OPTIMIZATION', 'caching'), ('ENABLE_OBSERVABILITY_METRICS', 'observability'), ('ENABLE_ROUTER_OPTIMIZATION', 'routing'), ('ENABLE_ORCHESTRATION', 'orchestration'), ('ENABLE_AGENT_BRIDGE', 'agents'), ('ENABLE_KNOWLEDGE_SHARING', 'knowledge'), ('ENABLE_RATE_LIMITING', 'rate_limiting'), ('ENABLE_DISTRIBUTED_CACHE', 'distributed_systems'), ('ENABLE_UNKNOWN_FEATURE', 'core')]
...
class TestConvenienceFunctions:
    ...
    def test_audit_feature_flags_success(self):
        ...
        with patch('src.core.configuration.feature_flag_audit.FeatureFlagAuditor') as mock_auditor_class:
            mock_auditor = Mock()
            mock_auditor.run_comprehensive_audit.return_value = Mock(total_flags=5, unused_flags=[], deprecated_flags=[], complex_flags=[], recommendations=[], audit_time=0.1)
    ...
    def test_audit_feature_flags_no_flags(self):
        ...
        with patch('src.core.configuration.feature_flag_audit.FeatureFlagAuditor') as mock_auditor_class:
            mock_auditor = Mock()
            mock_auditor.run_comprehensive_audit.return_value = Mock(total_flags=0, unused_flags=[], deprecated_flags=[], complex_flags=[], recommendations=[], audit_time=0.1)
            mock_auditor_class.return_value = mock_auditor
            result = audit_feature_flags(self.project_root)
    ...
    def test_simplify_feature_flags_success(self):
        ...
        with patch('src.core.configuration.feature_flag_audit.FeatureFlagAuditor') as mock_auditor_class:
            mock_auditor = Mock()
            mock_auditor.run_comprehensive_audit.return_value = Mock(total_flags=5, unused_flags=[], deprecated_flags=[], complex_flags=[], recommendations=['Test recommendation'], audit_time=0.1)
