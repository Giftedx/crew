...
from ultimate_discord_intelligence_bot.tools.analysis.claim_extractor_tool import ClaimExtractorTool
...
class TestClaimExtractorTool:
    ...
    def test_filter_duplicate_claims(self, tool):
        ...
        claims = [
            ...
            {"text": "The Earth is round", "confidence": 0.8},  # Duplicate
        ...
        assert filtered_claims[0]["confidence"] == 0.9  # Higher confidence kept
