...
class TestTools:
    ...
    @pytest.mark.tools
    def test_tools_operation(self, crew, test_tenant_context):
        ...
        with (
            ...
            assert "tools" not in str(result.raw).lower()
            assert "tool" not in str(result.raw).lower()
            assert "utility" not in str(result.raw).lower()
            assert "function" not in str(result.raw).lower()

    @pytest.mark.tools
    def test_tools_function(self, crew, test_tenant_context):
        """Test tools function."""
        with (
            patch("ultimate_discord_intelligence_bot.services.memory_service.MemoryService") as mock_memory,
            patch("ultimate_discord_intelligence_bot.services.prompt_engine.PromptEngine") as mock_prompt,
    ...
    @pytest.mark.tools
    def test_tools_class(self, crew, test_tenant_context):
        """Test tools class."""
        with (
            patch("ultimate_discord_intelligence_bot.services.memory_service.MemoryService") as mock_memory,
            patch("ultimate_discord_intelligence_bot.services.prompt_engine.PromptEngine") as mock_prompt,
    ...
    @pytest.mark.tools
    def test_tools_method(self, crew, test_tenant_context):
        """Test tools method."""
        with (
            patch("ultimate_discord_intelligence_bot.services.memory_service.MemoryService") as mock_memory,
            patch("ultimate_discord_intelligence_bot.services.prompt_engine.PromptEngine") as mock_prompt,
    ...
    @pytest.mark.tools
    def test_tools_property(self, crew, test_tenant_context):
        """Test tools property."""
        with (
            patch("ultimate_discord_intelligence_bot.services.memory_service.MemoryService") as mock_memory,
            patch("ultimate_discord_intelligence_bot.services.prompt_engine.PromptEngine") as mock_prompt,
    ...
    @pytest.mark.tools
    def test_tools_variable(self, crew, test_tenant_context):
        """Test tools variable."""
        with (
            patch("ultimate_discord_intelligence_bot.services.memory_service.MemoryService") as mock_memory,
            patch("ultimate_discord_intelligence_bot.services.prompt_engine.PromptEngine") as mock_prompt,
    ...
    @pytest.mark.tools
    def test_tools_constant(self, crew, test_tenant_context):
        """Test tools constant."""
        with (
            patch("ultimate_discord_intelligence_bot.services.memory_service.MemoryService") as mock_memory,
            patch("ultimate_discord_intelligence_bot.services.prompt_engine.PromptEngine") as mock_prompt,
    ...
    @pytest.mark.tools
    def test_tools_enum(self, crew, test_tenant_context):
        """Test tools enum."""
        with (
            patch("ultimate_discord_intelligence_bot.services.memory_service.MemoryService") as mock_memory,
            patch("ultimate_discord_intelligence_bot.services.prompt_engine.PromptEngine") as mock_prompt,
    ...
    @pytest.mark.tools
    def test_tools_interface(self, crew, test_tenant_context):
