...
class TestMem0MemoryTool:
    ...
    def test_remember_success(self, mock_mem0_service, mock_metrics):
        ...
        tool = Mem0MemoryTool()
        result = tool._run(action='remember', tenant='test_tenant', workspace='test_workspace', content='User prefers dark mode')
    ...
    def test_recall_success(self, mock_mem0_service, mock_metrics):
        ...
        tool = Mem0MemoryTool()
        result = tool._run(action='recall', tenant='test_tenant', workspace='test_workspace', query='dark mode preferences', limit=5)
        assert result.success
    ...
    def test_recall_default_limit(self, mock_mem0_service, mock_metrics):
        ...
        tool = Mem0MemoryTool()
        result = tool._run(action='recall', tenant='test_tenant', workspace='test_workspace', query='test query', limit=None)
        assert result.success
        call_args = mock_mem0_service.recall.call_args
    ...
    def test_update_success(self, mock_mem0_service, mock_metrics):
        ...
        tool = Mem0MemoryTool()
        result = tool._run(action='update', tenant='test_tenant', workspace='test_workspace', memory_id='mem_123', content='Updated preference: light mode')
        assert result.success
    ...
    def test_update_missing_memory_id(self, mock_mem0_service, mock_metrics):
        ...
        tool = Mem0MemoryTool()
        result = tool._run(action='update', tenant='test_tenant', workspace='test_workspace', memory_id=None, content='updated content')
        assert not result.success
    ...
    def test_update_missing_content(self, mock_mem0_service, mock_metrics):
        ...
        tool = Mem0MemoryTool()
        result = tool._run(action='update', tenant='test_tenant', workspace='test_workspace', memory_id='mem_123', content=None)
        assert not result.success
        assert 'memory_id and content must be provided' in result.error
        mock_mem0_service.update_memory.assert_not_called()
