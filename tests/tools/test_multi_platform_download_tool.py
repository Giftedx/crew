...
class TestMultiPlatformDownloadTool:
    ...
    def test_platform_detection(self, tool):
        ...
        test_cases = [
            ...
            ("https://www.reddit.com/r/subreddit/comments/123", "reddit"),
            ("https://www.twitch.tv/videos/123", "twitch"),
            ("https://kick.com/user/video/123", "kick"),
    ...
    def test_quality_fallback(self, tool, youtube_url):
        ...
        with patch.object(tool, "_download_youtube") as mock_download:
            mock_download.return_value = {
                "success": True,
                "platform": "youtube",
                "quality": "480p",  # Fallback quality
                "original_quality_requested": "1080p",
            }
    ...
    def test_platform_specific_handling(self, tool):
        ...
        # Test YouTube-specific parameters
        ...
        # Test Twitter-specific parameters
    ...
    def test_url_normalization(self, tool):
        ...
        test_cases = [
            ("https://youtube.com/watch?v=123", "https://www.youtube.com/watch?v=123"),
            ("youtube.com/watch?v=123", "https://www.youtube.com/watch?v=123"),
            ("https://youtu.be/123", "https://www.youtube.com/watch?v=123"),
        ]
