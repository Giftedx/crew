...
def test_maybe_compress_transcript_disabled():
    pipeline = _make_pipeline_stub(
        ...
        _transcript_compression_enabled=False,
    )
...
def test_maybe_compress_transcript_applies_basic_compression():
    pipeline = _make_pipeline_stub(
        prompt_engine=PromptEngine(),
        _transcript_compression_enabled=True,
        _transcript_compression_min_tokens=1,
        _transcript_compression_target_ratio=0.0,
        _transcript_compression_max_tokens=None,
    )
