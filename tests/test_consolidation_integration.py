...
class TestDeprecationMarkers:
    ...
    def test_deprecated_modules_have_markers(self):
        ...
        phase7_markers = [
            repo_root
            / "src/ultimate_discord_intelligence_bot/agent_training/performance_monitor_final.py.DEPRECATED",
            repo_root
            / "src/ultimate_discord_intelligence_bot/enhanced_performance_monitor.py.DEPRECATED",
            repo_root
            / "src/ultimate_discord_intelligence_bot/.DEPRECATED_PHASE7_ADVANCED_ANALYTICS",
        ]
