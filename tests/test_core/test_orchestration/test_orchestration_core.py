...
class TestOrchestrator(BaseOrchestrator):
    ...
    def __init__(
        self, name: str = "test_orchestrator", layer: OrchestrationLayer = OrchestrationLayer.APPLICATION
    ) -> None:
...
class TestOrchestrationContext:
    ...
    def test_context_creation(self):
        ...
        context = OrchestrationContext(
            tenant_id="test_tenant", request_id="req-123", metadata={"key": "value"}, trace_id="trace-456"
        )
