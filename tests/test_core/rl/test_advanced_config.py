...
import pytest
from platform.core.rl.advanced_config import AdvancedBanditConfigManager, AdvancedBanditGlobalConfig, DoublyRobustConfig, OffsetTreeConfig, get_config_manager
...
class TestDoublyRobustConfig:
    ...
    def test_custom_initialization(self):
        ...
        config = DoublyRobustConfig(alpha=2.0, learning_rate=0.05, dim=16, adaptive_learning_rate=False)
...
class TestOffsetTreeConfig:
    ...
    def test_custom_initialization(self):
        """Test custom configuration values."""
        config = OffsetTreeConfig(max_depth=5, min_samples_split=20, split_strategy='information_gain', base_bandit_type='epsilon_greedy')
...
class TestAdvancedBanditConfigManager:
    ...
    @patch.dict('os.environ', {'ENABLE_RL_ADVANCED': 'true', 'ENABLE_RL_SHADOW_EVAL': 'true', 'RL_ROLLOUT_PERCENTAGE': '0.25', 'RL_DR_ALPHA': '2.0', 'RL_DR_LEARNING_RATE': '0.05', 'RL_OT_MAX_DEPTH': '4'})
    ...
    @patch.dict('os.environ', {'RL_ROLLOUT_DOMAINS': 'model_routing,content_analysis', 'RL_ROLLOUT_TENANTS': 'tenant1,tenant2'})
    ...
    def test_set_domain_config(self):
        ...
        manager.set_domain_config('test_domain', doubly_robust_config=dr_config, offset_tree_config=ot_config)
    ...
    def test_is_enabled_for_domain(self):
        ...
        global_config = AdvancedBanditGlobalConfig(enable_advanced_bandits=True, rollout_domains=['allowed_domain'])
        manager._global_config = global_config
    ...
    def test_is_enabled_for_tenant(self):
        ...
        global_config = AdvancedBanditGlobalConfig(enable_advanced_bandits=True, rollout_tenants=['allowed_tenant'])
        manager._global_config = global_config
