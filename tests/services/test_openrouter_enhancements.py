...
from ultimate_discord_intelligence_bot.services.openrouter_service.async_execution import (
    AsyncExecutor,
    AsyncRouteManager,
)
from ultimate_discord_intelligence_bot.services.openrouter_service.batcher import (
    BatchConfig,
    RequestBatcher,
)
from ultimate_discord_intelligence_bot.services.openrouter_service.cache_warmer import (
    CacheCompressor,
    CacheWarmer,
    EnhancedCacheManager,
)
from ultimate_discord_intelligence_bot.services.openrouter_service.circuit_breaker import (
    CircuitBreaker,
    CircuitBreakerConfig,
    CircuitState,
)
from ultimate_discord_intelligence_bot.services.openrouter_service.connection_pool import (
    ConnectionPool,
    MockConnectionPool,
)
from ultimate_discord_intelligence_bot.services.openrouter_service.facade import (
    BudgetManager,
    CacheManager,
    MetricsCollector,
    OpenRouterServiceFacade,
)
from ultimate_discord_intelligence_bot.services.openrouter_service.health import (
    HealthChecker,
    HealthEndpoint,
)
from ultimate_discord_intelligence_bot.services.openrouter_service.monitoring import (
    AlertManager,
    AlertThreshold,
    PerformanceMonitor,
)
...
from ultimate_discord_intelligence_bot.services.openrouter_service.object_pool import (
    ObjectPool,
    RouteStatePool,
)
from ultimate_discord_intelligence_bot.services.openrouter_service.rate_limiter import (
...
from ultimate_discord_intelligence_bot.services.openrouter_service.registry import (
    OpenRouterServiceRegistry,
    ServiceRegistry,
)
from ultimate_discord_intelligence_bot.services.openrouter_service.retry_strategy import (
    RetryConfig,
    RetryManager,
    RetryStrategy,
)
...
class TestServiceRegistry:
    ...
    def test_health_check(self):
        ...
        # Should fail when no services are registered
...
class TestAsyncExecution:
    ...
    async def test_async_route_manager(self):
        ...
        # Mock the route method to return a successful result
        self.mock_service.route.return_value = StepResult.ok(data={"response": "test"})
...
class TestCacheWarmer:
    ...
    def test_enhanced_cache_manager(self):
        ...
        assert cached_data is None  # No cache hit initially
...
class TestMonitoring:
    ...
    def test_alert_manager(self):
        ...
        # Create test metrics
        from ultimate_discord_intelligence_bot.services.openrouter_service.monitoring import PerformanceMetrics

        metrics = PerformanceMetrics(
            timestamp=time.time(),
            latency_p50=100.0,
            latency_p95=5000.0,  # High latency
            latency_p99=10000.0,
            throughput_rps=1.0,
...
class TestRateLimiter:
    ...
    def test_openrouter_rate_limiter(self):
        ...
        # Should succeed if rate limit not exceeded
...
class TestIntegration:
    ...
    async def test_async_with_circuit_breaker(self):
        ...
        from ultimate_discord_intelligence_bot.services.openrouter_service.circuit_breaker import (
            get_openrouter_circuit_breaker,
        )
    ...
    def test_monitoring_with_health_checks(self):
        ...
        from ultimate_discord_intelligence_bot.services.openrouter_service.health import get_health_endpoint
