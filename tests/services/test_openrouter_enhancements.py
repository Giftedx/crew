...
from platform.llm.providers.openrouter.facade import BudgetManager, CacheManager, MetricsCollector, OpenRouterServiceFacade
...
from platform.llm.providers.openrouter.rate_limiter import OpenRouterRateLimiter, RateLimitConfig, RateLimitManager, SlidingWindowRateLimiter, TenantRateLimiter, TokenBucket
...
class TestObjectPool:
    ...
    def test_route_state_pool(self):
        ...
        with patch('ultimate_discord_intelligence_bot.services.openrouter_service.object_pool.FeatureFlags') as mock_flags:
...
class TestMonitoring:
    ...
    def test_alert_manager(self):
        ...
        metrics = PerformanceMetrics(timestamp=time.time(), latency_p50=100.0, latency_p95=5000.0, latency_p99=10000.0, throughput_rps=1.0, error_rate=15.0, cache_hit_rate=80.0, memory_usage_mb=100.0, cpu_usage_percent=50.0)
...
class TestRateLimiter:
    ...
    def setup_method(self):
        """Set up test fixtures."""
        self.config = RateLimitConfig(requests_per_minute=10, requests_per_hour=100, requests_per_day=1000, burst_limit=5)
