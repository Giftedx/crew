...
class TestCalculateEnhancedSummaryStatistics:
    ...
    def test_calculate_enhanced_summary_statistics_basic(self, mock_data_completeness, mock_basic_stats):
        ...
        mock_basic_stats.return_value = {"content_processed": True, "fact_checks_performed": 3, "deception_score": 0.3}
        ...
        results = {
            ...
            "temporal_analysis": {"coverage_days": 30, "relevance_score": 0.9, "historical_context": True},
        }
