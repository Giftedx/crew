...
class TestMediaPipeline:
    ...
    def test_asr_transcription(self):
        ...
        mock_segments = [
            ASRSegment(
                start_time=0.0, end_time=5.0, text="Hello, welcome to the podcast.", confidence=0.95, language="en"
            ),
            ASRSegment(
                start_time=5.0,
                end_time=10.0,
    ...
    def test_speaker_diarization(self):
        ...
        mock_segments = [
            DiarizationSegment(start_time=0.0, end_time=5.0, speaker="SPEAKER_00", confidence=None),
            DiarizationSegment(start_time=5.0, end_time=10.0, speaker="SPEAKER_01", confidence=None),
        ]
    ...
    def test_nlp_analysis(self):
        ...
        mock_nlp_result = NLPResult(
            ...
            keyphrases=[
                Keyphrase(text="machine learning", score=0.9, start_time=5.0, end_time=10.0, speaker="SPEAKER_01")
            ],
            entities=[
                Entity(text="AI", label="MISC", confidence=0.8, start_time=5.0, end_time=10.0, speaker="SPEAKER_01")
            ],
            claims=[],
            sentiment_analysis=[
                SentimentAnalysis(label="positive", score=0.8, start_time=0.0, end_time=5.0, speaker="SPEAKER_00"),
                SentimentAnalysis(label="neutral", score=0.6, start_time=5.0, end_time=10.0, speaker="SPEAKER_01"),
            ],
            content_safety=[
                ContentSafety(
                    toxicity_score=0.1,
