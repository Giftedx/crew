...
class TestASRMinimal:
    ...
    def test_step_result_usage(self):
        ...
        result = StepResult.ok(data={'transcript': self.test_transcript, 'language': 'en', 'confidence': 0.95, 'duration': 10.5})
    ...
    def test_whisper_config_validation(self):
        ...
        valid_config = {'model_size': 'large-v3', 'language': 'en', 'task': 'transcribe', 'temperature': 0.0, 'best_of': 1, 'beam_size': 1, 'patience': 1.0, 'length_penalty': 1.0, 'suppress_tokens': [-1], 'initial_prompt': None, 'condition_on_previous_text': True, 'fp16': True, 'compression_ratio_threshold': 2.4, 'logprob_threshold': -1.0, 'no_speech_threshold': 0.6, 'suppress_blank': True, 'without_timestamps': False, 'max_initial_timestamp': 0.0, 'word_timestamps': False, 'prepend_punctuations': '"\'¿([{-', 'append_punctuations': '"\'.,!?:;()[]{}', 'vad_filter': False, 'vad_parameters': None}
    ...
    def test_transcript_processing(self):
        ...
        timestamped_segments = [{'start': 0.0, 'end': 2.5, 'text': 'Hello world'}, {'start': 2.5, 'end': 5.0, 'text': 'This is a test'}]
    ...
    def test_memory_usage_estimation(self):
        ...
        duration_minutes = 10
        estimated_memory_mb = duration_minutes * 50
    ...
    def test_error_recovery_patterns(self):
        ...
        fallback_strategies = ['use_smaller_model', 'reduce_audio_quality', 'process_in_chunks', 'use_cpu_instead_of_gpu']
