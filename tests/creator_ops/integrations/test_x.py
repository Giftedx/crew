...
from ultimate_discord_intelligence_bot.creator_ops.integrations.x_models import XURL, XAnnotation, XCashtag, XCostGuard, XError, XHashtag, XMedia, XMention, XMentionResponse, XMeta, XPlace, XPoll, XRateLimit, XResponse, XSearchResponse, XTimelineResponse, XTweet, XTweetResponse, XUser, XUserResponse, XWebhookEvent, XWebhookSubscription
...
class TestXModels:
    ...
    def test_x_user_model(self):
        """Test XUser model."""
        user_data = {'id': '1234567890123456789', 'username': 'test_user', 'name': 'Test User', 'description': 'Test bio', 'profile_image_url': 'https://example.com/avatar.jpg', 'public_metrics': {'followers_count': 1000, 'following_count': 500, 'tweet_count': 100, 'listed_count': 10}, 'verified': True, 'protected': False, 'created_at': '2020-01-15T10:30:00.000Z', 'location': 'Test Location', 'url': 'https://test.com', 'pinned_tweet_id': '1234567890123456789', 'entities': {'url': {'urls': [{'start': 0, 'end': 23, 'url': 'https://test.com', 'expanded_url': 'https://test.com', 'display_url': 'test.com'}]}, 'description': {'hashtags': [], 'mentions': [], 'urls': []}}}
    ...
    def test_x_tweet_model(self):
        """Test XTweet model."""
        tweet_data = {'id': '1234567890123456789', 'text': 'Test tweet content', 'author_id': '1234567890123456789', 'created_at': '2024-01-15T10:30:00.000Z', 'public_metrics': {'retweet_count': 10, 'reply_count': 5, 'like_count': 100, 'quote_count': 2}, 'context_annotations': [{'domain': {'id': '47', 'name': 'Brand', 'description': 'Brands and Companies'}, 'entity': {'id': '1000000000000000000', 'name': 'Test Brand', 'description': 'Test brand description'}}], 'entities': {'hashtags': [{'start': 0, 'end': 5, 'tag': 'test'}], 'mentions': [], 'urls': []}, 'lang': 'en', 'possibly_sensitive': False, 'reply_settings': 'everyone', 'source': 'Twitter for iPhone', 'conversation_id': '1234567890123456789'}
    ...
    def test_x_media_model(self):
        """Test XMedia model."""
        media_data = {'media_key': '3_1234567890123456789', 'type': 'photo', 'url': 'https://example.com/image.jpg', 'preview_image_url': 'https://example.com/preview.jpg', 'alt_text': 'Test image', 'height': 1080, 'width': 1920, 'public_metrics': {'view_count': 1000}}
    ...
    def test_x_url_model(self):
        """Test XURL model."""
        url_data = {'start': 0, 'end': 23, 'url': 'https://example.com', 'expanded_url': 'https://example.com', 'display_url': 'example.com', 'title': 'Example Website', 'description': 'An example website', 'images': [{'url': 'https://example.com/image.jpg', 'width': 1200, 'height': 630}]}
        url = XURL(**url_data)
        assert url.start == 0
        assert url.end == 23
    ...
    def test_x_annotation_model(self):
        ...
        annotation_data = {'start': 0, 'end': 10, 'probability': 0.95, 'type': 'Person', 'normalized_text': 'Test Person'}
    ...
    def test_x_error_model(self):
        """Test XError model."""
        error_data = {'message': 'Invalid request', 'type': 'InvalidRequest', 'code': 400, 'title': 'Bad Request', 'detail': 'The request was invalid', 'parameter': 'query', 'resource_type': 'tweet', 'resource_id': '1234567890123456789', 'value': 'invalid_value'}
    ...
    def test_x_meta_model(self):
        """Test XMeta model."""
        meta_data = {'result_count': 10, 'next_token': 'next_token_12345', 'previous_token': 'previous_token_67890', 'newest_id': '1234567890123456789', 'oldest_id': '1234567890123456790', 'sent': '2024-01-15T10:30:00.000Z'}
    ...
    def test_x_cost_guard_model(self):
        ...
        cost_guard_data = {'tier': 'pro', 'monthly_tweet_cap': 100000, 'tweets_used': 5000, 'tweets_remaining': 95000, 'reset_date': '2024-02-15T00:00:00.000Z', 'cost_per_tweet': 0.0005, 'estimated_monthly_cost': 2.5}
    ...
    def test_x_webhook_subscription_model(self):
        ...
        subscription_data = {'id': 'webhook_123', 'url': 'https://example.com/webhook', 'valid': True, 'created_timestamp': '2024-01-15T10:30:00.000Z'}
    ...
    def test_x_webhook_event_model(self):
        ...
        event_data = {'for_user_id': '1234567890123456789', 'tweet_create_events': [{'id': '1234567890123456789', 'text': 'Test tweet', 'author_id': '1234567890123456789', 'created_at': '2024-01-15T10:30:00.000Z', 'public_metrics': {'retweet_count': 0, 'reply_count': 0, 'like_count': 0, 'quote_count': 0}, 'lang': 'en', 'possibly_sensitive': False, 'reply_settings': 'everyone', 'source': 'Twitter for iPhone', 'conversation_id': '1234567890123456789'}], 'tweet_delete_events': [], 'direct_message_events': [], 'follow_events': [], 'favorite_events': [], 'block_events': [], 'mute_events': [], 'user_event': None}
    ...
    def test_x_response_model(self):
        ...
        response_data = {'data': [{'id': '1234567890123456789', 'text': 'Test tweet', 'author_id': '1234567890123456789', 'created_at': '2024-01-15T10:30:00.000Z', 'public_metrics': {'retweet_count': 0, 'reply_count': 0, 'like_count': 0, 'quote_count': 0}, 'lang': 'en', 'possibly_sensitive': False, 'reply_settings': 'everyone', 'source': 'Twitter for iPhone', 'conversation_id': '1234567890123456789'}], 'meta': {'result_count': 1, 'newest_id': '1234567890123456789', 'oldest_id': '1234567890123456789'}, 'errors': [], 'includes': {'users': [], 'tweets': [], 'media': [], 'polls': [], 'places': []}}
    ...
    def test_x_user_response_model(self):
        ...
        response_data = {'data': [{'id': '1234567890123456789', 'username': 'test_user', 'name': 'Test User', 'description': 'Test bio', 'profile_image_url': 'https://example.com/avatar.jpg', 'public_metrics': {'followers_count': 1000, 'following_count': 500, 'tweet_count': 100, 'listed_count': 10}, 'verified': True, 'protected': False, 'created_at': '2020-01-15T10:30:00.000Z', 'location': 'Test Location', 'url': 'https://test.com', 'pinned_tweet_id': '1234567890123456789', 'entities': {'url': {'urls': [{'start': 0, 'end': 23, 'url': 'https://test.com', 'expanded_url': 'https://test.com', 'display_url': 'test.com'}]}, 'description': {'hashtags': [], 'mentions': [], 'urls': []}}}], 'meta': {'result_count': 1}, 'errors': [], 'includes': {'users': [], 'tweets': [], 'media': [], 'polls': [], 'places': []}}
...
class TestXClient:
    ...
    def test_check_rate_limit(self):
        ...
        mock_response = Mock()
        mock_response.headers = {'x-rate-limit-limit': '300', 'x-rate-limit-remaining': '250', 'x-rate-limit-reset': '1640995200', 'retry-after': '60'}
    ...
    def test_get_user_by_username_success(self):
        ...
        mock_response.json.return_value = {'data': {'id': '1234567890123456789', 'username': 'test_user', 'name': 'Test User', 'description': 'Test bio', 'profile_image_url': 'https://example.com/avatar.jpg', 'public_metrics': {'followers_count': 1000, 'following_count': 500, 'tweet_count': 100, 'listed_count': 10}, 'verified': True, 'protected': False, 'created_at': '2020-01-15T10:30:00.000Z', 'location': 'Test Location', 'url': 'https://test.com', 'pinned_tweet_id': '1234567890123456789', 'entities': {'url': {'urls': [{'start': 0, 'end': 23, 'url': 'https://test.com', 'expanded_url': 'https://test.com', 'display_url': 'test.com'}]}, 'description': {'hashtags': [], 'mentions': [], 'urls': []}}}}
        mock_response.headers = {'x-rate-limit-limit': '300', 'x-rate-limit-remaining': '250', 'x-rate-limit-reset': '1640995200'}
    ...
    def test_get_user_by_username_api_error(self):
        ...
        mock_response = Mock()
        mock_response.status_code = 200
        mock_response.json.return_value = {'errors': [{'message': 'User not found', 'type': 'ResourceNotFound', 'code': 404, 'title': 'Not Found', 'detail': 'The requested user was not found', 'parameter': 'username', 'resource_type': 'user', 'resource_id': 'test_user', 'value': 'test_user'}]}
    ...
    def test_get_user_timeline_success(self):
        ...
        mock_response = Mock()
        mock_response.status_code = 200
        mock_response.json.return_value = {'data': [{'id': '1234567890123456789', 'text': 'Test tweet', 'author_id': '1234567890123456789', 'created_at': '2024-01-15T10:30:00.000Z', 'public_metrics': {'retweet_count': 0, 'reply_count': 0, 'like_count': 0, 'quote_count': 0}, 'lang': 'en', 'possibly_sensitive': False, 'reply_settings': 'everyone', 'source': 'Twitter for iPhone', 'conversation_id': '1234567890123456789'}], 'meta': {'result_count': 1, 'newest_id': '1234567890123456789', 'oldest_id': '1234567890123456789', 'next_token': 'next_token_12345'}}
        mock_response.headers = {'x-rate-limit-limit': '300', 'x-rate-limit-remaining': '250', 'x-rate-limit-reset': '1640995200'}
        with patch('httpx.Client') as mock_client:
            mock_client_instance = Mock()
            mock_client_instance.request.return_value = mock_response
    ...
    def test_get_user_mentions_success(self):
        ...
        mock_response = Mock()
        mock_response.status_code = 200
        mock_response.json.return_value = {'data': [{'id': '1234567890123456789', 'text': '@test_user This is a mention!', 'author_id': '9876543210987654321', 'created_at': '2024-01-15T10:30:00.000Z', 'public_metrics': {'retweet_count': 0, 'reply_count': 0, 'like_count': 0, 'quote_count': 0}, 'lang': 'en', 'possibly_sensitive': False, 'reply_settings': 'everyone', 'source': 'Twitter for iPhone', 'conversation_id': '1234567890123456789'}], 'meta': {'result_count': 1, 'newest_id': '1234567890123456789', 'oldest_id': '1234567890123456789', 'next_token': 'next_mention_token_12345'}}
        mock_response.headers = {'x-rate-limit-limit': '300', 'x-rate-limit-remaining': '250', 'x-rate-limit-reset': '1640995200'}
        with patch('httpx.Client') as mock_client:
            mock_client_instance = Mock()
            mock_client_instance.request.return_value = mock_response
    ...
    def test_search_tweets_success(self):
        ...
        mock_response = Mock()
        mock_response.status_code = 200
        mock_response.json.return_value = {'data': [{'id': '1234567890123456789', 'text': 'Test search result', 'author_id': '1234567890123456789', 'created_at': '2024-01-15T10:30:00.000Z', 'public_metrics': {'retweet_count': 0, 'reply_count': 0, 'like_count': 0, 'quote_count': 0}, 'lang': 'en', 'possibly_sensitive': False, 'reply_settings': 'everyone', 'source': 'Twitter for iPhone', 'conversation_id': '1234567890123456789'}], 'meta': {'result_count': 1, 'newest_id': '1234567890123456789', 'oldest_id': '1234567890123456789', 'next_token': 'next_search_token_12345'}}
        mock_response.headers = {'x-rate-limit-limit': '300', 'x-rate-limit-remaining': '250', 'x-rate-limit-reset': '1640995200'}
        with patch('httpx.Client') as mock_client:
            mock_client_instance = Mock()
            mock_client_instance.request.return_value = mock_response
    ...
    def test_create_tweet_success(self):
        ...
        mock_response = Mock()
        mock_response.status_code = 200
        mock_response.json.return_value = {'data': {'id': '1234567890123456789', 'text': 'New test tweet', 'author_id': '1234567890123456789', 'created_at': '2024-01-15T10:30:00.000Z', 'public_metrics': {'retweet_count': 0, 'reply_count': 0, 'like_count': 0, 'quote_count': 0}, 'lang': 'en', 'possibly_sensitive': False, 'reply_settings': 'everyone', 'source': 'Twitter for iPhone', 'conversation_id': '1234567890123456789'}}
        mock_response.headers = {'x-rate-limit-limit': '300', 'x-rate-limit-remaining': '250', 'x-rate-limit-reset': '1640995200'}
        with patch('httpx.Client') as mock_client:
            mock_client_instance = Mock()
            mock_client_instance.request.return_value = mock_response
    ...
    def test_get_tweet_media_success(self):
        ...
        mock_response = Mock()
        mock_response.status_code = 200
        mock_response.json.return_value = {'data': {'id': '1234567890123456789', 'text': 'Test tweet with media', 'author_id': '1234567890123456789', 'created_at': '2024-01-15T10:30:00.000Z', 'public_metrics': {'retweet_count': 0, 'reply_count': 0, 'like_count': 0, 'quote_count': 0}, 'lang': 'en', 'possibly_sensitive': False, 'reply_settings': 'everyone', 'source': 'Twitter for iPhone', 'conversation_id': '1234567890123456789', 'attachments': {'media_keys': ['3_1234567890123456789']}}, 'includes': {'media': [{'media_key': '3_1234567890123456789', 'type': 'photo', 'url': 'https://example.com/image.jpg', 'preview_image_url': 'https://example.com/preview.jpg', 'alt_text': 'Test image', 'height': 1080, 'width': 1920, 'public_metrics': {'view_count': 1000}}]}}
        mock_response.headers = {'x-rate-limit-limit': '300', 'x-rate-limit-remaining': '250', 'x-rate-limit-reset': '1640995200'}
        with patch('httpx.Client') as mock_client:
            mock_client_instance = Mock()
            mock_client_instance.request.return_value = mock_response
    ...
    def test_get_tweet_poll_success(self):
        ...
        mock_response = Mock()
        mock_response.status_code = 200
        mock_response.json.return_value = {'data': {'id': '1234567890123456789', 'text': 'Test tweet with poll', 'author_id': '1234567890123456789', 'created_at': '2024-01-15T10:30:00.000Z', 'public_metrics': {'retweet_count': 0, 'reply_count': 0, 'like_count': 0, 'quote_count': 0}, 'lang': 'en', 'possibly_sensitive': False, 'reply_settings': 'everyone', 'source': 'Twitter for iPhone', 'conversation_id': '1234567890123456789', 'attachments': {'poll_ids': ['poll_1234567890123456789']}}, 'includes': {'polls': [{'id': 'poll_1234567890123456789', 'options': [{'position': 1, 'label': 'Option 1', 'votes': 10}, {'position': 2, 'label': 'Option 2', 'votes': 5}], 'duration_minutes': 60, 'end_datetime': '2024-01-15T11:30:00.000Z', 'voting_status': 'closed'}]}}
        mock_response.headers = {'x-rate-limit-limit': '300', 'x-rate-limit-remaining': '250', 'x-rate-limit-reset': '1640995200'}
        with patch('httpx.Client') as mock_client:
            mock_client_instance = Mock()
            mock_client_instance.request.return_value = mock_response
    ...
    def test_get_tweet_place_success(self):
        ...
        mock_response = Mock()
        mock_response.status_code = 200
        mock_response.json.return_value = {'data': {'id': '1234567890123456789', 'text': 'Test tweet with place', 'author_id': '1234567890123456789', 'created_at': '2024-01-15T10:30:00.000Z', 'public_metrics': {'retweet_count': 0, 'reply_count': 0, 'like_count': 0, 'quote_count': 0}, 'lang': 'en', 'possibly_sensitive': False, 'reply_settings': 'everyone', 'source': 'Twitter for iPhone', 'conversation_id': '1234567890123456789', 'geo': {'place_id': 'place_1234567890123456789'}}, 'includes': {'places': [{'id': 'place_1234567890123456789', 'name': 'Test Place', 'country_code': 'US', 'place_type': 'city', 'full_name': 'Test Place, US', 'country': 'United States', 'contained_within': [], 'geo': {'type': 'Point', 'bbox': [-74.0, 40.0, -73.0, 41.0], 'properties': {}}}]}}
        mock_response.headers = {'x-rate-limit-limit': '300', 'x-rate-limit-remaining': '250', 'x-rate-limit-reset': '1640995200'}
        with patch('httpx.Client') as mock_client:
            mock_client_instance = Mock()
            mock_client_instance.request.return_value = mock_response
    ...
    def test_create_webhook_subscription_success(self):
        ...
        result = self.client.create_webhook_subscription('1234567890123456789', 'https://example.com/webhook', ['tweet_create_events', 'tweet_delete_events'])
        assert result.success
