...
class TestXClient:
    ...
    def setup_method(self):
        ...
        # Add missing X config attributes that XClient expects
    ...
    def test_get_tweet_poll_success(self):
        ...
        mock_response.json.return_value = {
            "data": {
                ...
                "conversation_id": "1234567890123456789",
                "attachments": {
                    "poll_ids": ["poll_1234567890123456789"],
                },
            },
            "includes": {
                "polls": [
    ...
    def test_get_tweet_place_success(self):
        ...
        mock_response.json.return_value = {
            "data": {
                ...
                "conversation_id": "1234567890123456789",
                "geo": {
                    "place_id": "place_1234567890123456789",
                },
            },
            "includes": {
                "places": [
    ...
    def test_process_webhook_event_failure(self):
        ...
        event_data = {
            "for_user_id": "1234567890123456789",
            "tweet_create_events": "invalid_format",
        }
