...
class TestInstagramModels:
    ...
    def test_instagram_comment_model(self):
        ...
        comment_data = {
            ...
            "text": "Great post!",
            "timestamp": "2024-01-15T10:35:00+0000",
            "like_count": 10,
            "hidden": False,
            "user": {
    ...
    def test_instagram_story_model(self):
        ...
        story_data = {
            "id": "18100000000000000",
            "media_type": "IMAGE",
            "media_url": "https://example.com/story.jpg",
            "permalink": "https://www.instagram.com/stories/test_user/18100000000000000/",
    ...
    def test_instagram_insight_model(self):
        ...
        insight_data = {
            "name": "impressions",
            "period": "day",
            "values": [{"value": 1000, "end_time": "2024-01-15T00:00:00+0000"}],
            "title": "Impressions",
            ...
            "insights": [
                {
                    ...
                    "title": "Impressions",
                    "description": "Total number of times your content was viewed",
                    "id": "17900000000000000/insights/impressions/day",
                }
            ],
            "timestamp": "2024-01-15T10:30:00+0000",
        }
...
class TestInstagramClient:
    ...
    def setup_method(self):
        ...
        # Add missing Instagram config attributes that InstagramClient expects
    ...
    def test_initialization(self):
        ...
        assert (
            self.client.scope
            == "instagram_basic,instagram_manage_insights,instagram_manage_comments,instagram_manage_messages"
        )
    ...
    def test_get_user_media_success(self):
        ...
        mock_response.json.return_value = {
            ...
            "paging": {"cursors": {"after": "after_cursor_67890"}},
        }
        mock_response.headers = {}
    ...
    def test_get_media_comments_success(self):
        ...
        mock_response.json.return_value = {
            ...
            "paging": {"cursors": {"after": "after_comment_cursor_67890"}},
        }
        mock_response.headers = {}
