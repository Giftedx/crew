...
class TestTwitchClient:
    ...
    def test_create_clip_success(self):
            ...
            "data": [
                {
                    ...
                    "broadcaster_id": self.test_user_id,
        ...
        mock_response.status_code = 202  # Accepted for processing
    ...
    def test_followers_retrieval(self):
        ...
        mock_response.json.return_value = {
            "data": [
                ...
                {
                    "from_id": "follower2",
                    "from_login": "follower2",
                    "from_name": "Follower2",
                    "to_id": self.test_user_id,
                    "to_login": "testuser",
                    "to_name": "TestUser",
                    "followed_at": "2023-01-02T00:00:00Z",
                },
            ],
            "pagination": {"cursor": "next_cursor_token"},
            "total": 1000,
            ...
            "data": [
                {
                    ...
                    "type": "stream.online",
                    "version": "1",
                    "condition": {"broadcaster_user_id": self.test_user_id},
                    "transport": {
                        "method": "webhook",
    ...
    def test_large_response_handling(self):
        ...
        # Create a large response with many chat messages
        large_response = {
            "data": [
                {
                    "id": f"msg_{i}",
