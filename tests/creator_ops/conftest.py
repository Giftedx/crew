...
def sample_episode_data():
    ...
    return {'episode_id': 'episode_123', 'title': 'Test Episode', 'description': 'Test episode description', 'duration': 3600, 'transcript': 'This is a test episode transcript with multiple segments.', 'segments': [{'start_time': 0, 'end_time': 300, 'text': 'Introduction segment', 'speaker': 'SPEAKER_00'}, {'start_time': 300, 'end_time': 900, 'text': 'Main content segment 1', 'speaker': 'SPEAKER_01'}], 'metadata': {'channel_id': 'test_channel', 'platform': 'youtube', 'published_at': datetime.now().isoformat(), 'view_count': 100000, 'like_count': 5000, 'comment_count': 500, 'engagement_rate': 0.055}}

@pytest.fixture
def sample_chat_messages():
    """Provide sample chat messages."""
    return [{'message_id': 'msg_1', 'user_id': 'user_1', 'user_name': 'Viewer1', 'message': 'This is AMAZING!', 'created_at': datetime.now(), 'sentiment': 0.9, 'engagement': 150}, {'message_id': 'msg_2', 'user_id': 'user_2', 'user_name': 'Viewer2', 'message': 'EPIC moment!', 'created_at': datetime.now(), 'sentiment': 0.8, 'engagement': 120}]
