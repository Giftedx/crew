...
from ultimate_discord_intelligence_bot.core.multimodal import (
    AcousticFeatures,
    AudioAnalysisResult,
    AudioAnalysisType,
    # Audio analysis
...
class TestGlobalInstances:
    ...
    def test_global_image_analyzer(self) -> None:
        ...
        from ultimate_discord_intelligence_bot.core.multimodal import get_global_image_analyzer, set_global_image_analyzer

        # Test getting global analyzer
        analyzer1 = get_global_image_analyzer()
        assert isinstance(analyzer1, ImageAnalyzer)

        # Test setting global analyzer
    ...
    def test_global_audio_analyzer(self) -> None:
        ...
        from ultimate_discord_intelligence_bot.core.multimodal import get_global_audio_analyzer, set_global_audio_analyzer
    ...
    def test_global_video_analyzer(self) -> None:
        ...
        from ultimate_discord_intelligence_bot.core.multimodal import get_global_video_analyzer, set_global_video_analyzer
    ...
    def test_global_cross_modal_correlator(self) -> None:
        ...
        from ultimate_discord_intelligence_bot.core.multimodal import get_global_cross_modal_correlator, set_global_cross_modal_correlator

        # Test getting global correlator
        correlator1 = get_global_cross_modal_correlator()
        assert isinstance(correlator1, CrossModalCorrelator)

        # Test setting global correlator
...
class TestConvenienceFunctions:
    ...
    def test_image_convenience_functions(self) -> None:
        ...
        from ultimate_discord_intelligence_bot.core.multimodal import analyze_image, analyze_image_from_file
    ...
    def test_audio_convenience_functions(self) -> None:
        ...
        from ultimate_discord_intelligence_bot.core.multimodal import analyze_audio, analyze_audio_from_file
    ...
    def test_video_convenience_functions(self) -> None:
        ...
        from ultimate_discord_intelligence_bot.core.multimodal import analyze_video, analyze_video_from_file
    ...
    def test_cross_modal_convenience_function(self) -> None:
        ...
        from ultimate_discord_intelligence_bot.core.multimodal import analyze_cross_modal
