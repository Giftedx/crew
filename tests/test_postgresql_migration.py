...
def sample_memory_items():
    ...
    return [
        MemoryItem(
            ...
            type="conversation",
            content_json='{"text": "Hello world", "metadata": {"source": "test"}}',
        ...
        MemoryItem(
            ...
            workspace="test_workspace",
            type="fact",
            content_json='{"text": "The sky is blue", "metadata": {"source": "knowledge"}}',
...
def sample_debates():
    ...
    return [
        Debate(
            ...
            panel_config_json='{"agents": ["python_expert", "javascript_expert"]}',
            n_rounds=3,
            final_output="Python is better for data science, JavaScript for web development",
...
def sample_kg_nodes():
    ...
    return [
        KGNode(
            ...
            type="person",
            name="Ethan Klein",
            attrs_json='{"platforms": ["youtube", "tiktok"], "followers": 1000000}',
            created_at=datetime.now().isoformat(),
        ),
        KGNode(
            id=None,
            ...
            attrs_json='{"category": "content", "difficulty": "medium"}',
            created_at=datetime.now().isoformat(),
        ),
    ]
    ...
    return [
        CreatorProfile(
            ...
            data={
                ...
                "subscribers": 1000000,
                "content_types": ["podcast", "shorts", "long_form"],
                "collaborators": ["hasan_piker", "h3_crew"],
            },
        ),
        CreatorProfile(
            name="hasan_piker",
            data={
                ...
                "subscribers": 2000000,
                "content_types": ["streaming", "political_commentary"],
                "collaborators": ["ethan_klein", "destiny"],
            },
        ),
    ]
...
class TestMemoryStoreOperations:
    ...
    def test_prune_memory_items(self, store_manager, sample_memory_items):
        ...
        # Note: Actual pruning logic would depend on retention policies
...
class TestKnowledgeGraphOperations:
    ...
    def test_add_kg_node(self, store_manager, sample_kg_nodes):
        ...
        for node in sample_kg_nodes:
            result = store_manager.add_kg_node(
                tenant=node.tenant,
                type=node.type,
                name=node.name,
...
class TestErrorHandling:
    ...
    def test_invalid_memory_item_data(self, store_manager):
        ...
        invalid_item = MemoryItem(
            id=None,
            tenant="",  # Empty tenant should cause validation error
            workspace="test_workspace",
            type="conversation",
    ...
    def test_invalid_debate_data(self, store_manager):
        ...
        # Should fail due to empty query
        assert not result.success
