...
from ultimate_discord_intelligence_bot.core.routing.base_router import UnifiedRouter
from ultimate_discord_intelligence_bot.core.routing.llm_adapter import RouterLLMAdapter, create_router_llm
...
class TestRouterLLMAdapter:
    ...
    def test_extract_constraints(self) -> None:
        ...
        # Test temperature-based quality constraint
    ...
    def test_clear_cache(self) -> None:
        ...
        adapter.invoke(messages)  # Second call should use cache
