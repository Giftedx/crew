    ...
    def create(
        ...
        if segments is None:
            segments = [
                ...
                {"start": 5.0, "end": 10.0, "text": "transcript text.", "confidence": 0.9},
            ]
        if metadata is None:
            metadata = {
                "source": "youtube",
    ...
    def create_twitch_transcript() -> Transcript:
        ...
        return TranscriptFactory.create(
            ...
            segments=[
                ...
                {"start": 15.0, "end": 30.0, "text": "Let's talk about gaming and technology.", "confidence": 0.9},
            ],
            metadata={
                "source": "twitch",
    ...
    def create_multilingual_transcript() -> Transcript:
        ...
        return TranscriptFactory.create(
            ...
            segments=[
                ...
                {"start": 5.0, "end": 10.0, "text": "Hello everyone.", "confidence": 0.9, "language": "en"},
...
class AnalysisFactory:
    ...
    def create_debate_analysis() -> Analysis:
        ...
        return AnalysisFactory.create(
            ...
            entities=[
                ...
                {"text": "congress", "type": "ORGANIZATION", "confidence": 0.9},
    ...
    def create_educational_analysis() -> Analysis:
        ...
        return AnalysisFactory.create(
            ...
            entities=[
                ...
                {"text": "tutorial", "type": "CONTENT_TYPE", "confidence": 0.9},
            ],
    ...
    def create_negative_sentiment_analysis() -> Analysis:
        ...
        return AnalysisFactory.create(
            ...
            entities=[
                {"text": "customer service", "type": "CONCEPT", "confidence": 0.9},
