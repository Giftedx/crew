...
class TestGenerateAiRecommendations:
    ...
    def test_generate_ai_recommendations_low_scores(self):
        ...
        quality_dimensions = {"content_coherence": 0.3, "factual_accuracy": 0.2, "source_credibility": 0.4}
    ...
    def test_generate_ai_recommendations_invalid_dimensions(self):
        ...
        quality_dimensions = {"content_coherence": "invalid", "factual_accuracy": None, "valid_dimension": 0.3}
        ai_quality_score = 0.3
        analysis_data = {}
        verification_data = {}
