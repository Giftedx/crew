...
class TestTenantIsolation:
    ...
    def test_memory_namespace_isolation(self, memory_service, tenant1_context, tenant2_context):
        ...
        result1 = memory_service.add('Tenant 1 secret data', metadata={'sensitive': True}, namespace=f'{tenant1}:{workspace1}')
        result2 = memory_service.add('Tenant 2 secret data', metadata={'sensitive': True}, namespace=f'{tenant2}:{workspace2}')
