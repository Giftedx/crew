...
class TestEnhancedPIIDetector:
    ...
    def test_email_detection(self):
        ...
        test_cases = [('test@example.com', 'email'), ('user.name+tag@domain.co.uk', 'email'), ('admin@company.org', 'email')]
    ...
    def test_phone_detection(self):
        ...
        test_cases = [('555-123-4567', 'phone'), ('(555) 123-4567', 'phone'), ('+1-555-123-4567', 'phone'), ('555.123.4567', 'phone')]
        for text, expected_type in test_cases:
            result = self.detector.detect(text)
            found_types = [span.type for span in result.spans]
    ...
    def test_credit_card_detection(self):
        ...
        test_cases = [('4111-1111-1111-1111', 'credit_card'), ('4111 1111 1111 1111', 'credit_card'), ('4111111111111111', 'credit_card')]
        for text, expected_type in test_cases:
            result = self.detector.detect(text)
            found_types = [span.type for span in result.spans]
    ...
    def test_ssn_detection(self):
        ...
        test_cases = [('123-45-6789', 'ssn'), ('123.45.6789', 'ssn'), ('123456789', 'ssn')]
        for text, expected_type in test_cases:
            result = self.detector.detect(text)
            found_types = [span.type for span in result.spans]
    ...
    def test_ip_detection(self):
        ...
        test_cases = [('192.168.1.1', 'ip'), ('10.0.0.1', 'ip'), ('172.16.0.1', 'ip')]
        for text, expected_type in test_cases:
            result = self.detector.detect(text)
            found_types = [span.type for span in result.spans]
    ...
    def test_address_detection(self):
        ...
        test_cases = [('123 Main Street', 'address'), ('456 Oak Avenue', 'address'), ('789 Pine Road', 'address')]
        for text, expected_type in test_cases:
            result = self.detector.detect(text)
            found_types = [span.type for span in result.spans]
    ...
    def test_coordinates_detection(self):
        ...
        test_cases = [('40.7128, -74.0060', 'coordinates'), ('37.7749, -122.4194', 'coordinates')]
        for text, expected_type in test_cases:
            result = self.detector.detect(text)
            found_types = [span.type for span in result.spans]
    ...
    def test_api_key_detection(self):
        ...
        test_cases = [('sk-1234567890abcdef', 'api_key'), ('pk_test_1234567890abcdef', 'api_key'), ('ak_1234567890abcdef', 'api_key')]
        for text, expected_type in test_cases:
            result = self.detector.detect(text)
            found_types = [span.type for span in result.spans]
    ...
    def test_risk_level_assignment(self):
        ...
        test_cases = [('123-45-6789', 'critical'), ('4111-1111-1111-1111', 'critical'), ('test@example.com', 'high'), ('555-123-4567', 'high'), ('123 Main Street', 'medium')]
    ...
    def test_overlapping_spans_removal(self):
        ...
        spans = [EnhancedSpan('email', 0, 10, 'test@test.com', 0.9, 'low'), EnhancedSpan('email', 5, 15, 'test.com', 0.7, 'low')]
...
class TestEnhancedRedactor:
    ...
    def test_redact_with_metadata(self):
        ...
        from platform.core.privacy.enhanced_pii_detector import EnhancedSpan
        spans = [EnhancedSpan('email', 0, 16, 'test@example.com', 0.9, 'high')]
        detection_result = PIIDetectionResult(spans=spans, total_spans=1, risk_summary={'high': 1, 'medium': 0, 'low': 0, 'critical': 0}, confidence_score=0.9, processing_time=0.001)
    ...
    def test_validate_redaction_failure(self):
        ...
        original = 'Contact me at test@example.com'
        redacted = 'Contact me at test@example.com'
        result = self.redactor.validate_redaction(original, redacted)
    ...
    def test_multiple_spans_redaction(self):
        ...
        from platform.core.privacy.enhanced_pii_detector import EnhancedSpan
        spans = [EnhancedSpan('email', 0, 16, 'test@example.com', 0.9, 'high'), EnhancedSpan('phone', 20, 32, '555-123-4567', 0.9, 'high')]
