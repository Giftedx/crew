...
class TestCacheShadowHarness:
    ...
    @patch(
        "ultimate_discord_intelligence_bot.services.cache_shadow_harness.get_unified_cache"
    )
    @patch(
        "ultimate_discord_intelligence_bot.services.cache_shadow_harness.get_cache_namespace"
    )
    async def test_shadow_get_unified_hit_legacy_miss(
        self, mock_namespace, mock_cache_factory
    ):
    ...
    async def test_shadow_get_unified_miss_legacy_hit(
        self, mock_namespace, mock_cache_factory
    ):
    ...
    async def test_shadow_set_dual_write(self, mock_namespace, mock_cache_factory):
        ...
        self.harness.legacy_cache.set.assert_called_once_with(
    ...
    async def test_shadow_set_legacy_cache_error(
        self, mock_namespace, mock_cache_factory
    ):
