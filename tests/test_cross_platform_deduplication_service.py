...
class TestCrossPlatformDeduplicationService:
    ...
    def test_find_duplicates_with_text_items(self) -> None:
        ...
        text_items = [
            ...
            {"id": "item2", "text": "This is a test text", "platform": "twitter"},  # Duplicate
    ...
    def test_deduplicate_content_stream(self) -> None:
        ...
        content_items = [
            ...
            {"id": "item2", "content_type": "text", "text": "This is test content"},  # Duplicate
    ...
    def test_image_hash_generation_fallback(self) -> None:
        ...
        with patch("analysis.deduplication.cross_platform_deduplication_service.IMAGEHASH_AVAILABLE", False):
...
class TestCrossPlatformDeduplicationWithMocking:
    ...
    def test_find_image_duplicates_with_hash_mock(self) -> None:
        ...
        with patch("analysis.deduplication.cross_platform_deduplication_service.IMAGEHASH_AVAILABLE", True):
            with patch("analysis.deduplication.cross_platform_deduplication_service.imagehash") as mock_imagehash:
    ...
    def test_deduplicate_content_stream_with_mixed_types(self) -> None:
        ...
        content_items = [
            ...
            {"id": "img2", "content_type": "image", "image_path": "image1.jpg"},  # Duplicate image
            {"id": "txt2", "content_type": "text", "text": "Test content"},  # Duplicate text
        ]
