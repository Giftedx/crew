...
try:
    from ultimate_discord_intelligence_bot.core.platform.cross_platform_analytics import (
        CrossPlatformAnalytics,
    )
except Exception:  # pragma: no cover - optional component not available in some envs
    CrossPlatformAnalytics = None  # type: ignore
