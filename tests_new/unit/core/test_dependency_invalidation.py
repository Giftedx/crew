...
from core.cache.dependency_tracker import (
    DependencyNode,
    DependencyTracker,
)
from core.cache.invalidation_engine import (
    InvalidationEngine,
    InvalidationResult,
)
from core.cache.multi_level_cache import (
    CacheEntry,
    MultiLevelCache,
)
...
class TestInvalidationEngine:
    ...
    def engine(self, mock_tracker: AsyncMock) -> InvalidationEngine:
        ...
        return InvalidationEngine(
            dependency_tracker=mock_tracker,
            max_batch_size=10,
