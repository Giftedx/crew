...
class SemanticCache:
    ...
    def __init__(self, config: SemanticCacheConfig, embedding_function: Callable[[str], np.ndarray]):
        self.config = config
...
def create_semantic_cache(
    config: SemanticCacheConfig, embedding_function: Callable[[str], np.ndarray], adaptive: bool = True
) -> SemanticCache:
